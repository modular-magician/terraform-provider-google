...
// 1st bool is a change that requires a reboot and the second bool is a change that doesn't
func schedulingHasChange(d *schema.ResourceData) (bool, bool) {
	...
	if !reflect.DeepEqual(newNa, originalNa) {
		return true, false
	}

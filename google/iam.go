...
// Flattens AuditConfigs so each role+condition has a single Binding with combined members
...
// Flattens Bindings so each role+condition has a single Binding with combined members

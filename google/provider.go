...
func ResourceMapWithErrors() (map[string]*schema.Resource, error) {
	return mergeResourceMaps(
		map[string]*schema.Resource{
			...
			"google_big_query_dataset":                        resourceBigQueryDataset(),
			...
			"google_cloud_build_trigger":                      resourceCloudBuildTrigger(),
			...
			"google_security_center_source":                   resourceSecurityCenterSource(),
			"google_source_repo_repository":                   resourceSourceRepoRepository(),
			"google_source_repo_repository_iam_binding":       ResourceIamBinding(SourceRepoRepositoryIamSchema, SourceRepoRepositoryIamUpdaterProducer, SourceRepoRepositoryIdParseFunc),
			"google_source_repo_repository_iam_member":        ResourceIamMember(SourceRepoRepositoryIamSchema, SourceRepoRepositoryIamUpdaterProducer, SourceRepoRepositoryIdParseFunc),
			"google_source_repo_repository_iam_policy":        ResourceIamPolicy(SourceRepoRepositoryIamSchema, SourceRepoRepositoryIamUpdaterProducer, SourceRepoRepositoryIdParseFunc),

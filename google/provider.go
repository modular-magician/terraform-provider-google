...
func ResourceMapWithErrors() (map[string]*schema.Resource, error) {
	return mergeResourceMaps(
		map[string]*schema.Resource{
			...
			"google_iap_web_type_compute":                     resourceIapWebTypeCompute(),
			...
			"google_iap_web_type_app_engine":                  resourceIapWebTypeAppEngine(),
			...
			"google_iap_web_backend_service":                  resourceIapWebBackendService(),

...
var handwrittenDatasources = map[string]*schema.Resource{
	...
	"google_beyondcorp_app_connection":                           beyondcorp.DataSourceBeyondcorpAppConnection(),
	"google_beyondcorp_app_connector":                            beyondcorp.DataSourceBeyondcorpAppConnector(),

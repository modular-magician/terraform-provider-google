...
var generatedResources = map[string]*schema.Resource{
	...
	"google_memorystore_instance_desired_user_created_connections":               memorystore.ResourceMemorystoreInstanceDesiredUserCreatedConnections(),

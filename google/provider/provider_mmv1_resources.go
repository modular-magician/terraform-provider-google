...
var handwrittenIAMResources = map[string]*schema.Resource{
	...
	"google_project_iam_member":                  tpgiamresource.ResourceIamMember(resourcemanager.IamProjectSchema, resourcemanager.NewProjectIamUpdater, resourcemanager.ProjectIdParseFunc, tpgiamresource.IamWithBatching, tpgiamresource.IamWithResourceIdentity(resourcemanager.ProjectIamResourceIdentityParser)),

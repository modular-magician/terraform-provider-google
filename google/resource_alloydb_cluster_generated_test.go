	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"create_secondary", "initial_user", "cluster_id", "location"},
			},
		},
	})
}
...
func TestAccAlloydbCluster_alloydbClusterCrossRegionReplicationExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAlloydbCluster_alloydbClusterCrossRegionReplicationExample(context),
			},
			{
				ResourceName:            "google_alloydb_cluster.default",
				ImportState:             true,
...
func testAccAlloydbCluster_alloydbClusterCrossRegionReplicationExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_alloydb_cluster" "default" {
  cluster_id   = "tf-test-alloydb-cluster-full%{random_suffix}"
  location     = "us-central1"

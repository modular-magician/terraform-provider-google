...
func init() {
	resource.AddTestSweepers("ComputeAcceleratorType", &resource.Sweeper{
		Name: "ComputeAcceleratorType",
		F:    testSweepComputeAcceleratorType,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepComputeAcceleratorType(region string) error {
	resourceName := "ComputeAcceleratorType"
	...
	listTemplate := strings.Split("https://compute.googleapis.com/compute/v1/projects/{{project}}/aggregated/acceleratorTypes", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://compute.googleapis.com/compute/v1/projects/{{project}}/zones/{{zone}}/acceleratorTypes/{{name}}"
		if obj["zone"] == nil {

...
func resourceComputeBackendBucketSignedUrlKeyRead(d *schema.ResourceData, meta interface{}) error {
	...
	res, err = resourceComputeBackendBucketSignedUrlKeyExtractor(d, meta, res)
	if err != nil {
		return err
	}
...
func resourceComputeBackendBucketSignedUrlKeyExtractor(d *schema.ResourceData, meta interface{}, res map[string]interface{}) (map[string]interface{}, error) {
	config := meta.(*Config)

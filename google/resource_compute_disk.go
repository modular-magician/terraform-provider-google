...
func resourceComputeDiskCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("size"); !isEmptyValue(reflect.ValueOf(sizeGbProp)) {
		obj["sizeGb"] = sizeGbProp
	}
	typeProp, err := expandComputeDiskType(d.Get("type"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("type"); !isEmptyValue(reflect.ValueOf(typeProp)) {
		obj["type"] = typeProp
	}
	sourceImageProp, err := expandComputeDiskImage(d.Get("image"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("image"); !isEmptyValue(reflect.ValueOf(sourceImageProp)) {
		obj["sourceImage"] = sourceImageProp
	}
	zoneProp, err := expandComputeDiskZone(d.Get("zone"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("zone"); !isEmptyValue(reflect.ValueOf(zoneProp)) {
		obj["zone"] = zoneProp
	}
	sourceImageEncryptionKeyProp, err := expandComputeDiskSourceImageEncryptionKey(d.Get("source_image_encryption_key"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("source_image_encryption_key"); !isEmptyValue(reflect.ValueOf(sourceImageEncryptionKeyProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("disk_encryption_key"); !isEmptyValue(reflect.ValueOf(diskEncryptionKeyProp)) {
		obj["diskEncryptionKey"] = diskEncryptionKeyProp
	}
	sourceSnapshotProp, err := expandComputeDiskSnapshot(d.Get("snapshot"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("snapshot"); !isEmptyValue(reflect.ValueOf(sourceSnapshotProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("source_snapshot_encryption_key"); !isEmptyValue(reflect.ValueOf(sourceSnapshotEncryptionKeyProp)) {

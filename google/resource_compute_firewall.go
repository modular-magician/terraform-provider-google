...
func resourceComputeFirewallCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("allow"); !isEmptyValue(reflect.ValueOf(allowedProp)) {
		obj["allowed"] = allowedProp
	}
	deniedProp, err := expandComputeFirewallDeny(d.Get("deny"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("deny"); !isEmptyValue(reflect.ValueOf(deniedProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("destination_ranges"); !isEmptyValue(reflect.ValueOf(destinationRangesProp)) {
		obj["destinationRanges"] = destinationRangesProp
	}
	directionProp, err := expandComputeFirewallDirection(d.Get("direction"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("direction"); !isEmptyValue(reflect.ValueOf(directionProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("priority"); !isEmptyValue(reflect.ValueOf(priorityProp)) {
		obj["priority"] = priorityProp
	}
	sourceRangesProp, err := expandComputeFirewallSourceRanges(d.Get("source_ranges"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("source_ranges"); !isEmptyValue(reflect.ValueOf(sourceRangesProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("source_service_accounts"); !isEmptyValue(reflect.ValueOf(sourceServiceAccountsProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("source_tags"); !isEmptyValue(reflect.ValueOf(sourceTagsProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("target_service_accounts"); !isEmptyValue(reflect.ValueOf(targetServiceAccountsProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("target_tags"); !isEmptyValue(reflect.ValueOf(targetTagsProp)) {

...
func TestAccComputeGlobalForwardingRule_globalForwardingRuleBasicExample(t *testing.T) {
	t.Parallel()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeGlobalForwardingRule_globalForwardingRuleBasicExample(context),
			},
			{
...
func testAccComputeGlobalForwardingRule_globalForwardingRuleBasicExample(context map[string]interface{}) string {
	return Nprintf(`
...
resource "google_compute_target_pool" "default" {
  name = "target-pool-%{random_suffix}"
}
`, context)
}

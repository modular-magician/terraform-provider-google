...
func TestAccComputeGlobalForwardingRule_updateTarget(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeGlobalForwardingRule_httpProxy(fr, proxy, backend, hc, urlmap),
			...
			{
				Config: testAccComputeGlobalForwardingRule_httpProxy(fr, proxyUpdated, backend, hc, urlmap),
				Check: resource.ComposeTestCheckFunc(
					resource.TestMatchResourceAttr(
...
func testAccComputeGlobalForwardingRule_httpProxy(fr, proxy, backend, hc, urlmap string) string {
	return fmt.Sprintf(`

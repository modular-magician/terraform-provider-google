...
func resourceComputeHealthCheckCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("check_interval_sec"); !isEmptyValue(reflect.ValueOf(checkIntervalSecProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("healthy_threshold"); !isEmptyValue(reflect.ValueOf(healthyThresholdProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("timeout_sec"); !isEmptyValue(reflect.ValueOf(timeoutSecProp)) {
		obj["timeoutSec"] = timeoutSecProp
	}
	unhealthyThresholdProp, err := expandComputeHealthCheckUnhealthyThreshold(d.Get("unhealthy_threshold"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("unhealthy_threshold"); !isEmptyValue(reflect.ValueOf(unhealthyThresholdProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("http_health_check"); !isEmptyValue(reflect.ValueOf(httpHealthCheckProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("https_health_check"); !isEmptyValue(reflect.ValueOf(httpsHealthCheckProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("tcp_health_check"); !isEmptyValue(reflect.ValueOf(tcpHealthCheckProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("ssl_health_check"); !isEmptyValue(reflect.ValueOf(sslHealthCheckProp)) {

...
func flattenComputeHealthCheckHttp2HealthCheck(v interface{}, d *schema.ResourceData) interface{} {
	...
	transformed := make(map[string]interface{})
	transformed["request"] =
		flattenComputeHealthCheckHttp2HealthCheckRequest(original["request"], d)
	transformed["response"] =
...
func flattenComputeHealthCheckHttp2HealthCheckRequest(v interface{}, d *schema.ResourceData) interface{} {
	return v
}

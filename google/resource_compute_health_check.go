...
func flattenComputeHealthCheckSslHealthCheck(v interface{}, d *schema.ResourceData) interface{} {
	...
	transformed := make(map[string]interface{})
	transformed["request_path"] =
		flattenComputeHealthCheckSslHealthCheckRequestPath(original["requestPath"], d)
	transformed["response"] =
...
func flattenComputeHealthCheckSslHealthCheckRequestPath(v interface{}, d *schema.ResourceData) interface{} {
	return v
}

...
func testSweepComputeHealthCheck(region string) error {
	...
	listTemplate := strings.Split("https://www.googleapis.com/compute/v1/projects/{{project}}/global/healthChecks", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://www.googleapis.com/compute/v1/projects/{{project}}/global/healthChecks/{{name}}"

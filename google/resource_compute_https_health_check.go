...
func resourceComputeHttpsHealthCheckCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("host"); !isEmptyValue(reflect.ValueOf(hostProp)) {
		obj["host"] = hostProp
	}
	...
	if err != nil {
		return err
	} else if v := d.Get("port"); !isEmptyValue(reflect.ValueOf(portProp)) {
		obj["port"] = portProp
	}
	requestPathProp, err := expandComputeHttpsHealthCheckRequestPath(d.Get("request_path"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("request_path"); !isEmptyValue(reflect.ValueOf(requestPathProp)) {

...
func resourceComputeImageCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("disk_size_gb"); !isEmptyValue(reflect.ValueOf(diskSizeGbProp)) {
		obj["diskSizeGb"] = diskSizeGbProp
	}
	familyProp, err := expandComputeImageFamily(d.Get("family"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("family"); !isEmptyValue(reflect.ValueOf(familyProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("licenses"); !isEmptyValue(reflect.ValueOf(licensesProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("raw_disk"); !isEmptyValue(reflect.ValueOf(rawDiskProp)) {
		obj["rawDisk"] = rawDiskProp
	}
	sourceDiskProp, err := expandComputeImageSourceDisk(d.Get("source_disk"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("source_disk"); !isEmptyValue(reflect.ValueOf(sourceDiskProp)) {

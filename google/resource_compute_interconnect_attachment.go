...
func resourceComputeInterconnectAttachmentRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("operational_status", flattenComputeInterconnectAttachmentOperationalStatus(res["operationalStatus"])); err != nil {
		return fmt.Errorf("Error reading InterconnectAttachment: %s", err)
	}
...
func resourceComputeInterconnectAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return fmt.Errorf("Error deleting InterconnectAttachment %q: %s", d.Id(), err)
	}
...
func flattenComputeInterconnectAttachmentOperationalStatus(v interface{}) interface{} {
	return v
}

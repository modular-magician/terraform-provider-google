...
func resourceComputeInterconnectAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("interconnect"); !isEmptyValue(reflect.ValueOf(interconnectProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("edge_availability_domain"); !isEmptyValue(reflect.ValueOf(edgeAvailabilityDomainProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("candidate_subnets"); !isEmptyValue(reflect.ValueOf(candidateSubnetsProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("vlan_tag8021q"); !isEmptyValue(reflect.ValueOf(vlanTag8021qProp)) {

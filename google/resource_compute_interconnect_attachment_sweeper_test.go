...
func init() {
	resource.AddTestSweepers("ComputeInterconnectAttachment", &resource.Sweeper{
		Name: "ComputeInterconnectAttachment",
		F:    testSweepComputeInterconnectAttachment,
	})
}

func testSweepComputeInterconnectAttachment(region string) error {
	resource_name := "ComputeInterconnectAttachment"
	...
	list_template := strings.Split("https://www.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/interconnectAttachments", "?")[0]
	...
	for _, ri := range rl {
		...
		if strings.HasPrefix(name, "tf-test") {
			delete_template := "https://www.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/interconnectAttachments/{{name}}"

...
func testSweepComputeInterconnectAttachment(region string) error {
	resourceName := "ComputeInterconnectAttachment"
	...
	listTemplate := strings.Split("https://www.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/interconnectAttachments", "?")[0]
	...
	for _, obj := range rl {
		...
		deleteTemplate := "https://www.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/interconnectAttachments/{{name}}"

...
func resourceComputeNetworkEndpointGroupCreate(d *schema.ResourceData, meta interface{}) error {
	...
	url, err := replaceVars(d, config, "https://www.googleapis.com/compute/v1/projects/{{project}}/zones/{{zone}}/networkEndpointGroups")
	if err != nil {
		return err
	}
...
func resourceComputeNetworkEndpointGroupRead(d *schema.ResourceData, meta interface{}) error {
	...
	url, err := replaceVars(d, config, "https://www.googleapis.com/compute/v1/projects/{{project}}/zones/{{zone}}/networkEndpointGroups/{{name}}")
	if err != nil {
		return err
	}

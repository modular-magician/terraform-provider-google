...
func TestAccComputeRegionBackendService_regionBackendServiceStrongAffinityExample(t *testing.T) {
	t.Parallel()
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeRegionBackendService_regionBackendServiceStrongAffinityExample(context),
			},
			{
				ResourceName:            "google_compute_region_backend_service.default",
				ImportState:             true,
...
func testAccComputeRegionBackendService_regionBackendServiceStrongAffinityExample(context map[string]interface{}) string {
	return Nprintf(`
resource "google_compute_region_backend_service" "default" {
  name                            = "tf-test-region-service%{random_suffix}"
  region                          = "us-central1"

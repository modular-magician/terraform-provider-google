...
func TestAccRegionInstanceGroupManager_applyUpdatesToInstances(t *testing.T) {
	t.Parallel()
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccRegionInstanceGroupManager_applyUpdatesToInstances(template, igm),
			},
			{
				ResourceName:      "google_compute_region_instance_group_manager.igm-basic",
				ImportState:       true,
			...
			{
				Config: testAccRegionInstanceGroupManager_applyUpdatesToInstancesUpdated(template, igm),
			},
			{
				ResourceName:      "google_compute_region_instance_group_manager.igm-basic",
				ImportState:       true,
...
func testAccRegionInstanceGroupManager_applyUpdatesToInstances(template, igm string) string {
	return fmt.Sprintf(`
data "google_compute_image" "my_image" {
  family  = "debian-10"
  project = "debian-cloud"
...
resource "google_compute_region_instance_group_manager" "igm-basic" {
  ...
  base_instance_name = "igm-updating-test"
  region             = "us-central1"
  target_size        = 4
...
func testAccRegionInstanceGroupManager_applyUpdatesToInstancesUpdated(template, igm string) string {
	return fmt.Sprintf(`
data "google_compute_image" "my_image" {
  family  = "debian-9"
  project = "debian-cloud"

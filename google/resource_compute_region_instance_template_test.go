...
func TestAccComputeRegionInstanceTemplate_disks(t *testing.T) {
	t.Parallel()
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeRegionInstanceTemplate_disks(randString(t, 10)),
			},
			{
				ResourceName:      "google_compute_region_instance_template.foobar",
				ImportState:       true,
...
func TestAccComputeRegionInstanceTemplate_EncryptKMS(t *testing.T) {
	t.Parallel()
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeRegionInstanceTemplate_encryptionKMS(randString(t, 10), kms.CryptoKey.Name),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeRegionInstanceTemplateExists(t, "google_compute_region_instance_template.foobar", &instanceTemplate),
				),
			},
...
func TestAccComputeRegionInstanceTemplate_AdvancedMachineFeatures(t *testing.T) {
	...
	vcrTest(t, resource.TestCase{
		PreCheck:     func() { testAccPreCheck(t) },
		Providers:    testAccProviders,
		CheckDestroy: testAcctestAccComputeRegionInstanceTemplateDestroyProducer(t),
		Steps: []resource.TestStep{
			{
...
func TestAccComputeRegionInstanceTemplate_withScratchDisk(t *testing.T) {
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeRegionInstanceTemplate_withScratchDisk(randString(t, 10)),
			},
			{
				ResourceName:            "google_compute_region_instance_template.foobar",
				ImportState:             true,
...
func TestAccComputeRegionInstanceTemplate_sourceSnapshotEncryptionKey(t *testing.T) {
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeRegionInstanceTemplate_sourceSnapshotEncryptionKey(kmsRingName, kmsKeyName, randString(t, 10)),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeRegionInstanceTemplateExists(
...
func TestAccComputeRegionInstanceTemplate_sourceImageEncryptionKey(t *testing.T) {
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeRegionInstanceTemplate_sourceImageEncryptionKey(kmsRingName, kmsKeyName, randString(t, 10)),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeRegionInstanceTemplateExists(
						t, "google_compute_region_instance_template.template", &instanceTemplate),
				),
...
func testAccComputeRegionInstanceTemplate_disks(suffix string) string {
	return fmt.Sprintf(`
data "google_compute_image" "my_image" {
  family  = "debian-11"
  project = "debian-cloud"
...
func testAccComputeRegionInstanceTemplate_withScratchDisk(suffix string) string {
	return fmt.Sprintf(`
data "google_compute_image" "my_image" {
	family  = "centos-7"
...
func testAccComputeRegionInstanceTemplate_encryptionKMS(suffix, kmsLink string) string {
	return fmt.Sprintf(`
data "google_compute_image" "my_image" {
  family  = "debian-11"
  project = "debian-cloud"
...
func testAccComputeRegionInstanceTemplate_sourceSnapshotEncryptionKey(kmsRingName, kmsKeyName, suffix string) string {
	return fmt.Sprintf(`
...
func testAccComputeRegionInstanceTemplate_sourceImageEncryptionKey(kmsRingName, kmsKeyName, suffix string) string {
	return fmt.Sprintf(`
data "google_kms_key_ring" "ring" {
  name     = "%s"
  location = "us-central1"

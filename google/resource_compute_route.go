...
func resourceComputeRouteCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("dest_range"); !isEmptyValue(reflect.ValueOf(destRangeProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("tags"); !isEmptyValue(reflect.ValueOf(tagsProp)) {
		obj["tags"] = tagsProp
	}
	nextHopGatewayProp, err := expandComputeRouteNextHopGateway(d.Get("next_hop_gateway"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("next_hop_gateway"); !isEmptyValue(reflect.ValueOf(nextHopGatewayProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("next_hop_instance"); !isEmptyValue(reflect.ValueOf(nextHopInstanceProp)) {
		obj["nextHopInstance"] = nextHopInstanceProp
	}
	nextHopIpProp, err := expandComputeRouteNextHopIp(d.Get("next_hop_ip"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("next_hop_ip"); !isEmptyValue(reflect.ValueOf(nextHopIpProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("next_hop_vpn_tunnel"); !isEmptyValue(reflect.ValueOf(nextHopVpnTunnelProp)) {

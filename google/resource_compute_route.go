...
func resourceComputeRouteCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("dest_range"); ok || !reflect.DeepEqual(v, destRangeProp) {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("tags"); ok || !reflect.DeepEqual(v, tagsProp) {
		obj["tags"] = tagsProp
	}
	nextHopGatewayProp, err := expandComputeRouteNextHopGateway(d.Get("next_hop_gateway"), d, config)
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("next_hop_gateway"); ok || !reflect.DeepEqual(v, nextHopGatewayProp) {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("next_hop_instance"); ok || !reflect.DeepEqual(v, nextHopInstanceProp) {
		obj["nextHopInstance"] = nextHopInstanceProp
	}
	nextHopIpProp, err := expandComputeRouteNextHopIp(d.Get("next_hop_ip"), d, config)
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("next_hop_ip"); ok || !reflect.DeepEqual(v, nextHopIpProp) {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("next_hop_vpn_tunnel"); ok || !reflect.DeepEqual(v, nextHopVpnTunnelProp) {

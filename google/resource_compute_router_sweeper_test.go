...
func testSweepComputeRouter(region string) error {
	...
	listTemplate := strings.Split("https://www.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/routers", "?")[0]
	...
	for _, obj := range rl {
		...
		deleteTemplate := "https://www.googleapis.com/compute/v1/projects/{{project}}/regions/{{region}}/routers/{{name}}"

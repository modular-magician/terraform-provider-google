...
func testSweepComputeSslCertificate(region string) error {
	resourceName := "ComputeSslCertificate"
	...
	listTemplate := strings.Split("https://www.googleapis.com/compute/v1/projects/{{project}}/global/sslCertificates", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://www.googleapis.com/compute/v1/projects/{{project}}/global/sslCertificates/{{name}}"

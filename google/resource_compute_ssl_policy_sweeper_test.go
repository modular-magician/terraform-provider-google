...
func testSweepComputeSslPolicy(region string) error {
	...
	listTemplate := strings.Split("https://www.googleapis.com/compute/v1/projects/{{project}}/global/sslPolicies", "?")[0]
	...
	for _, obj := range rl {
		...
		deleteTemplate := "https://www.googleapis.com/compute/v1/projects/{{project}}/global/sslPolicies/{{name}}"

...
func resourceComputeSubnetworkCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("ip_cidr_range"); !isEmptyValue(reflect.ValueOf(ipCidrRangeProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("fingerprint"); !isEmptyValue(reflect.ValueOf(fingerprintProp)) {
		obj["fingerprint"] = fingerprintProp
	}
	secondaryIpRangesProp, err := expandComputeSubnetworkSecondaryIpRange(d.Get("secondary_ip_range"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("secondary_ip_range"); !isEmptyValue(reflect.ValueOf(secondaryIpRangesProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("private_ip_google_access"); !isEmptyValue(reflect.ValueOf(privateIpGoogleAccessProp)) {

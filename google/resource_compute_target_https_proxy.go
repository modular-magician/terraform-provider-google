...
func resourceComputeTargetHttpsProxyCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("url_map"); ok || !reflect.DeepEqual(v, urlMapProp) {
...
func resourceComputeTargetHttpsProxyUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("url_map") {
		...
		if err != nil {
			return err
		} else if v, ok := d.GetOkExists("url_map"); ok || !reflect.DeepEqual(v, urlMapProp) || d.HasChange("url_map") {
			obj["urlMap"] = urlMapProp
		}

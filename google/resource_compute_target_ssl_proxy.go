...
func resourceComputeTargetSslProxyCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("proxy_header"); ok || !reflect.DeepEqual(v, proxyHeaderProp) {
		obj["proxyHeader"] = proxyHeaderProp
	}
	serviceProp, err := expandComputeTargetSslProxyBackendService(d.Get("backend_service"), d, config)
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("backend_service"); ok || !reflect.DeepEqual(v, serviceProp) {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("ssl_certificates"); ok || !reflect.DeepEqual(v, sslCertificatesProp) {
		obj["sslCertificates"] = sslCertificatesProp
	}
	sslPolicyProp, err := expandComputeTargetSslProxySslPolicy(d.Get("ssl_policy"), d, config)
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("ssl_policy"); ok || !reflect.DeepEqual(v, sslPolicyProp) {
...
func resourceComputeTargetSslProxyUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("proxy_header") {
		...
		if err != nil {
			return err
		} else if v, ok := d.GetOkExists("proxy_header"); ok || !reflect.DeepEqual(v, proxyHeaderProp) || d.HasChange("proxy_header") {
			obj["proxyHeader"] = proxyHeaderProp
		}
	...
	if d.HasChange("backend_service") {
		...
		if err != nil {
			return err
		} else if v, ok := d.GetOkExists("backend_service"); ok || !reflect.DeepEqual(v, serviceProp) || d.HasChange("backend_service") {
			obj["service"] = serviceProp
		}
	...
	if d.HasChange("ssl_certificates") {
		...
		if err != nil {
			return err
		} else if v, ok := d.GetOkExists("ssl_certificates"); ok || !reflect.DeepEqual(v, sslCertificatesProp) || d.HasChange("ssl_certificates") {
			obj["sslCertificates"] = sslCertificatesProp
		}
	...
	if d.HasChange("ssl_policy") {
		...
		if err != nil {
			return err
		} else if v, ok := d.GetOkExists("ssl_policy"); ok || !reflect.DeepEqual(v, sslPolicyProp) || d.HasChange("ssl_policy") {
			obj["sslPolicy"] = sslPolicyProp
		}

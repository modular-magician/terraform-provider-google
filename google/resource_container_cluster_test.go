...
func TestAccContainerCluster_withMeshCertificatesConfig(t *testing.T) {
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccContainerCluster_updateMeshCertificatesConfig(pid, clusterName),
			},
			{
				ResourceName:            "google_container_cluster.with_mesh_certificates_config",
				ImportState:             true,
...
func testAccContainerCluster_updateMeshCertificatesConfig(projectID string, clusterName string) string {

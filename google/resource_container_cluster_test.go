...
func TestAccContainerCluster_withGcpPublicCidrsAccessEnabledToggle(t *testing.T) {
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerCluster_withGcpPublicCidrsAccessEnabled(clusterName, "", ""),
				Check: resource.ComposeTestCheckFunc(
...
func testAccContainerCluster_withGcpPublicCidrsAccessEnabled(clusterName string, flag string, emptyValue string) string {

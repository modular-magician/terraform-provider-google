...
func resourceDataprocClusterRead(d *schema.ResourceData, meta interface{}) error {
	...
	log.Println(spew.Sdump(cluster.Config))
	log.Println(spew.Sdump(cluster.VirtualClusterConfig))
	if cluster.Config != nil {
		log.Println("Flattening cluster config")
		...
		log.Println("Flattening virtual cluster config")

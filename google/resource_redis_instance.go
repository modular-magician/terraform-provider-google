...
func resourceRedisInstanceCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("alternative_location_id"); !isEmptyValue(reflect.ValueOf(alternativeLocationIdProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("authorized_network"); !isEmptyValue(reflect.ValueOf(authorizedNetworkProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("display_name"); !isEmptyValue(reflect.ValueOf(displayNameProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("redis_configs"); !isEmptyValue(reflect.ValueOf(redisConfigsProp)) {
		obj["redisConfigs"] = redisConfigsProp
	}
	locationIdProp, err := expandRedisInstanceLocationId(d.Get("location_id"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("location_id"); !isEmptyValue(reflect.ValueOf(locationIdProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("memory_size_gb"); !isEmptyValue(reflect.ValueOf(memorySizeGbProp)) {
		obj["memorySizeGb"] = memorySizeGbProp
	}
	redisVersionProp, err := expandRedisInstanceRedisVersion(d.Get("redis_version"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("redis_version"); !isEmptyValue(reflect.ValueOf(redisVersionProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("reserved_ip_range"); !isEmptyValue(reflect.ValueOf(reservedIpRangeProp)) {
		obj["reservedIpRange"] = reservedIpRangeProp
	}
	tierProp, err := expandRedisInstanceTier(d.Get("tier"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("tier"); !isEmptyValue(reflect.ValueOf(tierProp)) {
		obj["tier"] = tierProp
	}
...
func resourceRedisInstanceImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	config := meta.(*Config)
	if err := parseImportId([]string{"projects/(?P<project>[^/]+)/locations/(?P<region>[^/]+)/instances/(?P<name>[^/]+)", "(?P<project>[^/]+)/(?P<region>[^/]+)/(?P<name>[^/]+)", "(?P<name>[^/]+)"}, d, config); err != nil {
		return nil, err
	}

...
func testSweepRedisInstance(region string) error {
	...
	listTemplate := strings.Split("https://redis.googleapis.com/v1/projects/{{project}}/locations/{{region}}/instances", "?")[0]
	...
	for _, obj := range rl {
		...
		deleteTemplate := "https://redis.googleapis.com/v1/projects/{{project}}/locations/{{region}}/instances/{{name}}"

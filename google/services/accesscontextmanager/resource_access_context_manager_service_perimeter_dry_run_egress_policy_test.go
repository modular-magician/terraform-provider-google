...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/accesscontextmanager/resource_access_context_manager_service_perimeter_dry_run_egress_policy_test.go
//
...
func testAccAccessContextManagerServicePerimeterDryRunEgressPolicy_updateTest(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccAccessContextManagerServicePerimeterDryRunEgressPolicy_egressPolicyUpdate_step2(org, policyTitle, perimeterTitle, projectNumber),
...
func testAccAccessContextManagerServicePerimeterDryRunEgressPolicy_egressPolicyUpdate_step2(org, policyTitle, perimeterTitleName, projectNumber string) string {
	return fmt.Sprintf(`
%s
...
// step 3: update operations, change identity_type, swap sources to access_level

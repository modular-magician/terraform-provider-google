...
func listAndActionAgenticApplicationsAnalystAgentPersona(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://agenticapplications.googleapis.com/v1main/projects/{{project}}/locations/{{location}}/analystAgentPersonas", "?")[0]
...
func deleteResourceAgenticApplicationsAnalystAgentPersona(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://agenticapplications.googleapis.com/v1main/projects/{{project}}/locations/{{location}}/analystAgentPersonas/{{analyst_agent_persona_id}}"

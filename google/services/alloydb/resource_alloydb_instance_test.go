		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("google_alloydb_instance.default", "psc_instance_info.0.effective_psc_auto_dns_enabled", "true"),
					resource.TestCheckResourceAttr("google_alloydb_instance.default", "psc_instance_info.0.effective_psc_auto_connection_policy", "true"),
				),
			},
			{
...
resource "google_alloydb_instance" "default" {
  ...
  psc_instance_config {
    psc_auto_connection_policy_state = "ENABLED"
    psc_auto_dns_state = "PSC_AUTO_DNS_STATE_ENABLED"

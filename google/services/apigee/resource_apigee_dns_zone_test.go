...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/apigee/resource_apigee_dns_zone_test.go
//
...
func TestAccApigeeDnsZone_apigeeDnsZoneBasicTest(t *testing.T) {
	// This test provisions a brand-new project and an Apigee organization (a
	// long-running, billed operation), matching the other project-creating
	// Apigee acceptance tests (e.g. TestAccApigeeOrganization_*,
	// TestAccApigeeInstance_*) which all skip VCR for the same reason.
	acctest.SkipIfVcr(t)
	t.Parallel()

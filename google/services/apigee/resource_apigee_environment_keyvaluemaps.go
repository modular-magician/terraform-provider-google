...
func resourceApigeeEnvironmentKeyvaluemapsRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("encrypted", flattenApigeeEnvironmentKeyvaluemapsEncrypted(res["encrypted"], d, config)); err != nil {
		return fmt.Errorf("Error reading EnvironmentKeyvaluemaps: %s", err)
	}
...
func flattenApigeeEnvironmentKeyvaluemapsEncrypted(v interface{}, d *schema.ResourceData, config *transport_tpg.Config) interface{} {
	return v
}

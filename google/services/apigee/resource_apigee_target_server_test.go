...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/apigee/resource_apigee_target_server_test.go
//
...
func TestAccApigeeTargetServer_apigeeTargetServerTest_update(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccApigeeTargetServer_apigeeTargetServerTest_basicDisable(context),
			},
			{
				ResourceName:            "google_apigee_target_server.apigee_target_server",
				ImportState:             true,
...
func testAccApigeeTargetServer_apigeeTargetServerTest_basicDisable(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_project" "project" {
  project_id      = "tf-test%{random_suffix}"
  name            = "tf-test%{random_suffix}"

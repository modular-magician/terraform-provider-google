...
func TestAccAppEngineDomainMappingListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_app_engine_domain_mapping.domain_mapping",
						[]string{
							"name",
							"domain_name",
						},
			...
			{
				Query:           true,
				Config:          testAccAppEngineDomainMapping_appEngineDomainMappingBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_app_engine_domain_mapping.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_app_engine_domain_mapping.list_query",
...
func testAccAppEngineDomainMapping_appEngineDomainMappingBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_app_engine_domain_mapping" "list_query" {
    provider = google
	limit = 10000
    config {
    }

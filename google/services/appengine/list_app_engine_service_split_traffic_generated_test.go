...
func TestAccAppEngineServiceSplitTrafficListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_app_engine_service_split_traffic.liveapp",
						[]string{
							"service",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccAppEngineServiceSplitTraffic_appEngineServiceSplitTrafficExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_app_engine_service_split_traffic.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_app_engine_service_split_traffic.list_query",
...
func testAccAppEngineServiceSplitTraffic_appEngineServiceSplitTrafficExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_app_engine_service_split_traffic" "list_query" {
    provider = google
	limit = 10000
    config {
    }

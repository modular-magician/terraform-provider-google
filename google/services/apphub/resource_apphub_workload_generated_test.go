...
func TestAccApphubWorkload_apphubWorkloadBasicExample(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccApphubWorkload_apphubWorkloadBasicExample(context),
			},
			{
...
func testAccApphubWorkload_apphubWorkloadBasicExample(context map[string]interface{}) string {
...
func TestAccApphubWorkload_apphubWorkloadFullExample(t *testing.T) {
	...
	context := map[string]interface{}{
		...
		"desc":                          "tf-test-Register service for testing" + randomSuffix,
		"developer_email":               "tf-test-bob@google.com" + randomSuffix,
		"developer_name":                "tf-test-Bob" + randomSuffix,
		"display_name":                  "tf-test-Example Service Full" + randomSuffix,
		"ilb_network":                   "tf-test-l7-ilb-network" + randomSuffix,
		"ilb_subnet":                    "tf-test-l7-ilb-subnet" + randomSuffix,
		"instance_template":             "tf-test-l7-ilb-mig-template" + randomSuffix,
		"mig":                           "tf-test-l7-ilb-mig1" + randomSuffix,
...
func testAccApphubWorkload_apphubWorkloadFullExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_apphub_application" "application" {
  location = "us-central1"
  application_id = "%{application_id}"
...
func testAccCheckApphubWorkloadDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			if rs.Type != "google_apphub_workload" {
				continue
			}
			...
			url, err := tpgresource.ReplaceVarsForTest(config, rs, "{{ApphubBasePath}}projects/{{project}}/locations/{{location}}/applications/{{application_id}}/workloads/{{workload_id}}")
			if err != nil {
				return err
			}

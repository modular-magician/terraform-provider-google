...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/backupdr/data_source_backup_dr_backup_plan_associations_test.go
//
...
func testAccCheckBackupPlanAssociationInList(dataSourceName, instanceName, backupPlanName, projectDsName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		// Reconstruct the 'resource' string using the project NUMBER and instance ID
		...
		// Normalize the backup plan name to also use the project NUMBER.

...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/backupdr/data_source_backup_dr_data_source_references.go
//
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"total_stored_bytes": {
							Type:        schema.TypeInt,
							Computed:    true,
							Description: "The total stored bytes for the data source.",
						},
					},
				},
			},
...
func flattenDataSourceReferences(items []interface{}) ([]map[string]interface{}, error) {
	...
	for _, item := range items {
		...
		if v, ok := data["totalStoredBytes"].(string); ok {
			if i, err := strconv.Atoi(v); err == nil {
				ref["total_stored_bytes"] = i
			}
		}

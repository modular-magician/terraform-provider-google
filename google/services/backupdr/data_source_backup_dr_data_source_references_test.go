...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/backupdr/data_source_backup_dr_data_source_references_test.go
//
		...
		Steps: []resource.TestStep{
			{
				...
				Check: func(s *terraform.State) error {
					...
					return resource.ComposeTestCheckFunc(
						...
						resource.TestCheckResourceAttrSet("data.google_backup_dr_data_source_references.default", "data_source_references.0.total_stored_bytes"),
					)(s)
				},
			},
		},

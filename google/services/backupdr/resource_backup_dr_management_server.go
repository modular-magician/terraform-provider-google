	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"location": {
				...
				Required:    true,
				ForceNew:    true,
				Description: `Specify location for management server (management console)`,
			},
			"name": {
				Type:        schema.TypeString,
				Required:    true,
				ForceNew:    true,
				Description: `Specify the name of management server (management console)`,
			},
			"networks": {
				Type:        schema.TypeList,
				Required:    true,
				ForceNew:    true,
				Description: `Specify network details.`,
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"network": {
							...
							Required:    true,
							ForceNew:    true,
							Description: `Specify network with format 'projects/{{project_id}}/global/networks/{{network_id}}'`,
						},
						"peering_mode": {
							Type:         schema.TypeString,
							Optional:     true,
							ForceNew:     true,
							ValidateFunc: verify.ValidateEnum([]string{"PRIVATE_SERVICE_ACCESS", "PEERING_MODE_UNSPECIFIED", ""}),
							Description:  `Specify Network peeringMode Default value: "PRIVATE_SERVICE_ACCESS" Possible values: ["PRIVATE_SERVICE_ACCESS", "PEERING_MODE_UNSPECIFIED"]`,
			...
			"type": {
				...
				Optional:     true,
				ForceNew:     true,
				ValidateFunc: verify.ValidateEnum([]string{"BACKUP_RESTORE", "DR", ""}),
				Description:  `Specify the type of management server (management console) Default value: "BACKUP_RESTORE" Possible values: ["BACKUP_RESTORE", "DR"]`,

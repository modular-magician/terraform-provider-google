...
func DataSourceBeyondcorpAppConnection() *schema.Resource {
	rs := ResourceBeyondcorpAppConnection().Schema
	...
	return &schema.Resource{
		Read:   dataSourceBeyondcorpAppConnectionRead,
		Schema: dsSchema,
	}
}

func dataSourceBeyondcorpAppConnectionRead(d *schema.ResourceData, meta interface{}) error {

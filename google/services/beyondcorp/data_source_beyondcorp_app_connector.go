...
func DataSourceBeyondcorpAppConnector() *schema.Resource {
	rs := ResourceBeyondcorpAppConnector().Schema
	...
	return &schema.Resource{
		Read:   dataSourceBeyondcorpAppConnectorRead,
		Schema: dsSchema,
	}
}

func dataSourceBeyondcorpAppConnectorRead(d *schema.ResourceData, meta interface{}) error {

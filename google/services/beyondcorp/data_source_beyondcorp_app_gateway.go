...
func DataSourceBeyondcorpAppGateway() *schema.Resource {
	rs := ResourceBeyondcorpAppGateway().Schema
	...
	return &schema.Resource{
		Read:   dataSourceBeyondcorpAppGatewayRead,
		Schema: dsSchema,
	}
}

func dataSourceBeyondcorpAppGatewayRead(d *schema.ResourceData, meta interface{}) error {

...
func DataSourceBeyondcorpApplication() *schema.Resource {
	rs := ResourceBeyondcorpApplication().Schema

	dsSchema := tpgresource.DatasourceSchemaFromResourceSchema(rs)

	tpgresource.AddRequiredFieldsToSchema(dsSchema, "security_gateways_id", "application_id")

	tpgresource.AddOptionalFieldsToSchema(dsSchema, "project")

	return &schema.Resource{
		Read:   dataSourceBeyondcorpApplicationRead,
		Schema: dsSchema,
	}
}

func dataSourceBeyondcorpApplicationRead(d *schema.ResourceData, meta interface{}) error {
	...
	err = resourceBeyondcorpApplicationRead(d, meta)
	if err != nil {
		return err
	}

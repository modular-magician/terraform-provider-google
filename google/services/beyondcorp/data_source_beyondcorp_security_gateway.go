...
func DataSourceBeyondcorpSecurityGateway() *schema.Resource {
	rs := ResourceBeyondcorpSecurityGateway().Schema

	dsSchema := tpgresource.DatasourceSchemaFromResourceSchema(rs)

	tpgresource.AddRequiredFieldsToSchema(dsSchema, "location", "security_gateway_id")

	tpgresource.AddOptionalFieldsToSchema(dsSchema, "project")

	return &schema.Resource{
		Read:   dataSourceBeyondcorpSecurityGatewayRead,
		Schema: dsSchema,
	}
}

func dataSourceBeyondcorpSecurityGatewayRead(d *schema.ResourceData, meta interface{}) error {

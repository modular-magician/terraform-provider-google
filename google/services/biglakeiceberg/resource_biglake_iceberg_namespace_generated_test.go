...
func TestAccBiglakeIcebergIcebergNamespace_biglakeIcebergNamespaceExample(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccBiglakeIcebergIcebergNamespace_biglakeIcebergNamespaceExample(context),
			},
			{
...
func testAccCheckBiglakeIcebergIcebergNamespaceDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			if rs.Type != "google_biglake_iceberg_namespace" {
				continue
			}
			...
			if err == nil {
				return fmt.Errorf("BiglakeIcebergIcebergNamespace still exists at %s", url)
			}
		}

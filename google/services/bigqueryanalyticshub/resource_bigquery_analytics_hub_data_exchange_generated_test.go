...
func TestAccBigqueryAnalyticsHubDataExchange_bigqueryAnalyticshubDataExchangeSharingExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccBigqueryAnalyticsHubDataExchange_bigqueryAnalyticshubDataExchangeSharingExample(context),
			},
			{
				ResourceName:            "google_bigquery_analytics_hub_data_exchange.data_exchange",
				ImportState:             true,
...
func testAccBigqueryAnalyticsHubDataExchange_bigqueryAnalyticshubDataExchangeSharingExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_bigquery_analytics_hub_data_exchange" "data_exchange" {
  location         = "US"
  data_exchange_id = "tf_test_my_data_exchange%{random_suffix}"
...
func TestAccBigqueryAnalyticsHubDataExchange_bigqueryAnalyticshubDataExchangeSharingDcrExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccBigqueryAnalyticsHubDataExchange_bigqueryAnalyticshubDataExchangeSharingDcrExample(context),
			},
			{
				ResourceName:            "google_bigquery_analytics_hub_data_exchange.data_exchange",
				ImportState:             true,
...
func testAccBigqueryAnalyticsHubDataExchange_bigqueryAnalyticshubDataExchangeSharingDcrExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_bigquery_analytics_hub_data_exchange" "data_exchange" {
  location         = "US"
  data_exchange_id = "tf_test_my_data_exchange%{random_suffix}"

...
func TestAccBigqueryAnalyticsHubListingSubscription_bigqueryAnalyticshubListingSubscriptionMultiregionExample(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccBigqueryAnalyticsHubListingSubscription_bigqueryAnalyticshubListingSubscriptionMultiregionExample(context),
			},
			{
				ResourceName:            "google_bigquery_analytics_hub_listing_subscription.subscription",
				ImportState:             true,
...
func testAccBigqueryAnalyticsHubListingSubscription_bigqueryAnalyticshubListingSubscriptionMultiregionExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_bigquery_analytics_hub_data_exchange" "subscription" {
  location         = "us"
  data_exchange_id = "tf_test_my_data_exchange%{random_suffix}"
  display_name     = "tf_test_my_data_exchange%{random_suffix}"
  description      = "example listing multiregion subscription%{random_suffix}"
}

...
func TestAccCertificateManagerCertificateListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccCertificateManagerCertificate_certificateManagerSelfManagedCertificateRegionalExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_certificate_manager_certificate.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_certificate_manager_certificate.list_query",
...
func testAccCertificateManagerCertificate_certificateManagerSelfManagedCertificateRegionalExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_certificate_manager_certificate" "list_query" {
    provider = google
	limit = 10000
    config {
    }

...
func TestAccCertificateManagerDnsAuthorizationListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccCertificateManagerDnsAuthorization_certificateManagerDnsAuthorizationRegionalExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_certificate_manager_dns_authorization.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_certificate_manager_dns_authorization.list_query",
...
func testAccCertificateManagerDnsAuthorization_certificateManagerDnsAuthorizationRegionalExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_certificate_manager_dns_authorization" "list_query" {
    provider = google
	limit = 10000
    config {
    }

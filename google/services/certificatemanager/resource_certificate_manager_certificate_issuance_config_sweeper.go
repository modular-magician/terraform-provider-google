...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCertificateManagerCertificateIssuanceConfig,
		DeleteFunction: testSweepCertificateManagerCertificateIssuanceConfig,
	}
...
func testSweepCertificateManagerCertificateIssuanceConfig(_ string) error {
	return listAndActionCertificateManagerCertificateIssuanceConfig(deleteResourceCertificateManagerCertificateIssuanceConfig)
}

func listAndActionCertificateManagerCertificateIssuanceConfig(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "CertificateManagerCertificateIssuanceConfig"
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'certificateIssuanceConfigs'")
		} else {
...
func deleteResourceCertificateManagerCertificateIssuanceConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {

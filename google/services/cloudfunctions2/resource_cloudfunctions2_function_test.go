...
func TestAccCloudFunctions2Function_trafficSplit(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCloudfunctions2function_trafficSplitInitial(context),
			},
			{
...
func testAccCloudfunctions2function_trafficSplitInitial(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_storage_bucket" "bucket" {
  name     = "tf-test-gcf-repro-bucket%{random_suffix}"
  location = "US"
  uniform_bucket_level_access = true
}
...
resource "google_cloudfunctions2_function" "traffic-split-function" {
  name = "tf-test-repro-function%{random_suffix}"
  location = "us-central1"
...
func testAccCloudfunctions2function_trafficSplitUpdate(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_storage_bucket" "bucket" {
  name     = "tf-test-gcf-repro-bucket%{random_suffix}"
  location = "US"

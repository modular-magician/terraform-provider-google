...
func TestAccCloudRunV2Job_cloudrunv2JobWithTCPStartupProbeUpdate(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCloudRunV2Job_cloudrunv2JobWithTCPStartupProbe(context),
			},
			{
				ResourceName:            "google_cloud_run_v2_job.default",
				ImportState:             true,
...
func testAccCloudRunV2Job_cloudrunv2JobWithTCPStartupProbe(context map[string]interface{}) string {
	return acctest.Nprintf(`
  resource "google_cloud_run_v2_job" "default" {
    name     = "%{job_name}"
    location = "us-central1"
...
func TestAccCloudRunV2Job_cloudrunv2JobWithHTTPStartupProbeUpdate(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCloudRunV2Job_cloudrunv2JobWithEmptyHTTPStartupProbe(context),
			},
			{
				ResourceName:            "google_cloud_run_v2_job.default",
				ImportState:             true,
			...
			{
				Config: testAccCloudRunV2Job_cloudrunv2JobWithHTTPStartupProbe(context),
			},
			{
				ResourceName:            "google_cloud_run_v2_job.default",
				ImportState:             true,
...
func testAccCloudRunV2Job_cloudrunv2JobWithEmptyHTTPStartupProbe(context map[string]interface{}) string {
	return acctest.Nprintf(`
  resource "google_cloud_run_v2_job" "default" {
    name     = "%{job_name}"
    location = "us-central1"
...
func testAccCloudRunV2Job_cloudrunv2JobWithHTTPStartupProbe(context map[string]interface{}) string {
	return acctest.Nprintf(`
  resource "google_cloud_run_v2_job" "default" {
    name     = "%{job_name}"
    location = "us-central1"
...
func TestAccCloudRunV2Job_cloudrunv2JobWithGRPCStartupProbeUpdate(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCloudRunV2Job_cloudrunv2JobWithEmptyGRPCStartupProbe(context),
			},
			{
				ResourceName:            "google_cloud_run_v2_job.default",
				ImportState:             true,
			...
			{
				Config: testAccCloudRunV2Job_cloudrunv2JobWithGRPCStartupProbe(context),
			},
			{
				ResourceName:            "google_cloud_run_v2_job.default",
				ImportState:             true,
...
func testAccCloudRunV2Job_cloudrunv2JobWithEmptyGRPCStartupProbe(context map[string]interface{}) string {
	return acctest.Nprintf(`
  resource "google_cloud_run_v2_job" "default" {
    name     = "%{job_name}"
    location = "us-central1"
...
func testAccCloudRunV2Job_cloudrunv2JobWithGRPCStartupProbe(context map[string]interface{}) string {
	return acctest.Nprintf(`
  resource "google_cloud_run_v2_job" "default" {
    name     = "%{job_name}"
    location = "us-central1"

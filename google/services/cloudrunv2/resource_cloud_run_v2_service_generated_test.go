...
func TestAccCloudRunV2Service_cloudrunv2ServiceIapExample(t *testing.T) {
	...
	context := map[string]interface{}{
		"cloud_run_service_name": "tf-test-cloudrun-iap-service" + randomSuffix,
		"random_suffix":          randomSuffix,
	}
...
func TestAccCloudRunV2Service_cloudrunv2ServiceEmptydirDiskExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCloudRunV2Service_cloudrunv2ServiceEmptydirDiskExample(context),
			},
			{
				ResourceName:            "google_cloud_run_v2_service.default",
				ImportState:             true,
...
func testAccCloudRunV2Service_cloudrunv2ServiceEmptydirDiskExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_cloud_run_v2_service" "default" {
  name     = "%{cloud_run_service_name}"
  location = "us-central1"
...
func TestAccCloudRunV2Service_cloudrunv2ServiceEmptydirDiskTestExample(t *testing.T) {
	t.Parallel()

	randomSuffix := acctest.RandString(t, 10)

	context := map[string]interface{}{
		"cloud_run_service_name": "tf-test-cloudrunservice" + randomSuffix,
		"deletion_protection":    false,
		"random_suffix":          randomSuffix,
	}
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCloudRunV2Service_cloudrunv2ServiceEmptydirDiskTestExample(context),
			},
			{
				ResourceName:            "google_cloud_run_v2_service.default",
				ImportState:             true,
...
func testAccCloudRunV2Service_cloudrunv2ServiceEmptydirDiskTestExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_cloud_run_v2_service" "default" {
  name     = "%{cloud_run_service_name}"
  location = "us-central1"

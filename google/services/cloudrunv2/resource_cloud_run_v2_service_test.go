...
func TestAccCloudRunV2Service_cloudrunv2ServiceReservedEnvPort(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccCloudRunV2Service_cloudrunv2ServiceReservedEnvPort(context),
				PlanOnly:    true,
				ExpectError: regexp.MustCompile(`expected template\.0\.containers\.0\.env\.\d+\.name to not be any of \[PORT\]`),
			},
		},
	})
}

func testAccCloudRunV2Service_cloudrunv2ServiceReservedEnvPort(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_cloud_run_v2_service" "default" {

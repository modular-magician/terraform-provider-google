...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/cloudrunv2/runadminv3_operation.go
//
...
func (w *RunAdminV2OperationWaiter) QueryOp() (interface{}, error) {
	...
	url := fmt.Sprintf("%s%s", w.Config.BasePaths["cloudrunv2"], w.CommonOperationWaiter.Op.Name)

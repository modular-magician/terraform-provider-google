...
func TestAccColabRuntime_update(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccColabRuntime_image_upgrade(context),
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
						plancheck.ExpectResourceAction("google_colab_runtime.runtime", plancheck.ResourceActionDestroyBeforeCreate),
					},
				},
			},
			{
...
func testAccColabRuntime_image_upgrade(context map[string]interface{}) string {

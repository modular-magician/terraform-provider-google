		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("data.google_compute_network_attachment.default", "producer_accept_lists.*", fmt.Sprintf("tf-test-prj-accept1-%s", context["random_suffix"])),
					resource.TestCheckTypeSetElemAttr("data.google_compute_network_attachment.default", "producer_accept_lists.*", fmt.Sprintf("tf-test-prj-accept2-%s", context["random_suffix"])),

...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/compute/data_source_google_compute_subnetworks.go
//
...
func dataSourceGoogleComputeSubnetworksRead(d *schema.ResourceData, meta interface{}) error {
	...
	subnetworkList, err := DEPRECATED_LegacyApiaryClient(config, userAgent).Subnetworks.List(project, region).Filter(filter).Do()
	if err != nil {

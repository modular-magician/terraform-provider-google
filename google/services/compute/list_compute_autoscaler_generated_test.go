...
func TestAccComputeAutoscalerListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_autoscaler.foobar",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeAutoscaler_autoscalerBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_autoscaler.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_autoscaler.list_query",
...
func testAccComputeAutoscaler_autoscalerBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_autoscaler" "list_query" {
    provider = google
	limit = 10000
    config {
    }

...
func TestAccComputeBackendBucketListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeBackendBucket_backendBucketBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_backend_bucket.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_backend_bucket.list_query",
...
func testAccComputeBackendBucket_backendBucketBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_backend_bucket" "list_query" {
    provider = google
	limit = 10000
    config {
    }

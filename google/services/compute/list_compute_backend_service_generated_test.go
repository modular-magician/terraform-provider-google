...
func TestAccComputeBackendServiceListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeBackendService_backendServiceBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_backend_service.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_backend_service.list_query",
...
func testAccComputeBackendService_backendServiceBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_backend_service" "list_query" {
    provider = google
	limit = 10000
    config {
    }

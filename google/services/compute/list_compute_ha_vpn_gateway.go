...
func init() {
	registry.FrameworkListResource{
		...
		ProductName: "Compute",
		Func:        NewComputeHaVpnGatewayListResource,
	}.Register()
}

var _ list.ListResource = &ComputeHaVpnGatewayListResource{}

type ComputeHaVpnGatewayListResource struct {
	tpgresource.ListResourceMetadata
}

func NewComputeHaVpnGatewayListResource() list.ListResource {
	listR := &ComputeHaVpnGatewayListResource{}
	listR.TypeName = "google_compute_ha_vpn_gateway"
	listR.SDKv2Resource = ResourceComputeHaVpnGateway()
...
// ComputeHaVpnGatewayListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type ComputeHaVpnGatewayListModel struct {
	Region  types.String `tfsdk:"region"`
	Project types.String `tfsdk:"project"`
}

func (listR *ComputeHaVpnGatewayListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data ComputeHaVpnGatewayListModel
...
func ListComputeHaVpnGateways(config *transport_tpg.Config,
	region string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceComputeHaVpnGateway().Data(&terraform.InstanceState{})
	if region != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{ComputeBasePath}}projects/{{project}}/regions/{{region}}/vpnGateways")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceComputeHaVpnGateway(),
		ListURL:        url,
		...
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err = ResourceComputeHaVpnGatewayFlatten(d, config, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}

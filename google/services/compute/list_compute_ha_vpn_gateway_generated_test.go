...
func TestAccComputeHaVpnGatewayListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeHaVpnGateway_haVpnGatewayBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_ha_vpn_gateway.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_ha_vpn_gateway.list_query",

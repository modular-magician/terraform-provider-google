...
func TestAccComputeHealthCheckListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeHealthCheck_healthCheckTcpExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_health_check.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_health_check.list_query",
...
func testAccComputeHealthCheck_healthCheckTcpExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_health_check" "list_query" {
    provider = google
	limit = 10000
    config {
    }

...
func TestAccComputeHttpHealthCheckListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeHttpHealthCheck_httpHealthCheckBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_http_health_check.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_http_health_check.list_query",
...
func testAccComputeHttpHealthCheck_httpHealthCheckBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_http_health_check" "list_query" {
    provider = google
	limit = 10000
    config {
    }

...
func init() {
	registry.FrameworkListResource{
		...
		ProductName: "Compute",
		Func:        NewComputeInterconnectAttachmentListResource,
	}.Register()
}

var _ list.ListResource = &ComputeInterconnectAttachmentListResource{}

type ComputeInterconnectAttachmentListResource struct {
	tpgresource.ListResourceMetadata
}

func NewComputeInterconnectAttachmentListResource() list.ListResource {
	listR := &ComputeInterconnectAttachmentListResource{}
	listR.TypeName = "google_compute_interconnect_attachment"
	listR.SDKv2Resource = ResourceComputeInterconnectAttachment()
...
// ComputeInterconnectAttachmentListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type ComputeInterconnectAttachmentListModel struct {
	Region  types.String `tfsdk:"region"`
	Project types.String `tfsdk:"project"`
}

func (listR *ComputeInterconnectAttachmentListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data ComputeInterconnectAttachmentListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListComputeInterconnectAttachments(
			listR.Client,
			region,
			project,
...
func ListComputeInterconnectAttachments(config *transport_tpg.Config,
	region string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceComputeInterconnectAttachment().Data(&terraform.InstanceState{})
	if region != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{ComputeBasePath}}projects/{{project}}/regions/{{region}}/interconnectAttachments")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceComputeInterconnectAttachment(),
		ListURL:        url,
		...
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err = ResourceComputeInterconnectAttachmentFlatten(d, config, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}

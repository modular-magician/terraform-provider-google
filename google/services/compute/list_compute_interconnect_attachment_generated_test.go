...
func TestAccComputeInterconnectAttachmentListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeInterconnectAttachment_interconnectAttachmentBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_interconnect_attachment.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_interconnect_attachment.list_query",
...
func testAccComputeInterconnectAttachment_interconnectAttachmentBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_interconnect_attachment" "list_query" {
    provider = google
	limit = 10000
    config {
    }

...
func TestAccComputeManagedSslCertificateListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeManagedSslCertificate_managedSslCertificateBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_managed_ssl_certificate.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_managed_ssl_certificate.list_query",
...
func testAccComputeManagedSslCertificate_managedSslCertificateBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_managed_ssl_certificate" "list_query" {
    provider = google
	limit = 10000
    config {
    }

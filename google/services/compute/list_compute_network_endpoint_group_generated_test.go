...
func TestAccComputeNetworkEndpointGroupListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeNetworkEndpointGroup_networkEndpointGroupExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_network_endpoint_group.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_network_endpoint_group.list_query",
...
func testAccComputeNetworkEndpointGroup_networkEndpointGroupExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_network_endpoint_group" "list_query" {
    provider = google
	limit = 10000
    config {
    }

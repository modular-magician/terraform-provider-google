...
func init() {
	registry.FrameworkListResource{
		...
		ProductName: "Compute",
		Func:        NewComputeNetworkFirewallPolicyListResource,
	}.Register()
}

var _ list.ListResource = &ComputeNetworkFirewallPolicyListResource{}

type ComputeNetworkFirewallPolicyListResource struct {
	tpgresource.ListResourceMetadata
}

func NewComputeNetworkFirewallPolicyListResource() list.ListResource {
	listR := &ComputeNetworkFirewallPolicyListResource{}
	listR.TypeName = "google_compute_network_firewall_policy"
	listR.SDKv2Resource = ResourceComputeNetworkFirewallPolicy()
...
// ComputeNetworkFirewallPolicyListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type ComputeNetworkFirewallPolicyListModel struct {
	Project types.String `tfsdk:"project"`
}

func (listR *ComputeNetworkFirewallPolicyListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data ComputeNetworkFirewallPolicyListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListComputeNetworkFirewallPolicys(
			listR.Client,
			project,
...
func ListComputeNetworkFirewallPolicys(config *transport_tpg.Config,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceComputeNetworkFirewallPolicy().Data(&terraform.InstanceState{})
	if project != "" {
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceComputeNetworkFirewallPolicy(),
		ListURL:        url,
		...
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err = ResourceComputeNetworkFirewallPolicyFlatten(d, config, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}

...
func TestAccComputeNetworkListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeNetwork_networkBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_network.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_network.list_query",
...
func testAccComputeNetwork_networkBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_network" "list_query" {
    provider = google
	limit = 10000
    config {
    }

...
func TestAccComputeNodeGroupListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_node_group.nodes",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeNodeGroup_nodeGroupBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_node_group.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_node_group.list_query",
...
func testAccComputeNodeGroup_nodeGroupBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_node_group" "list_query" {
    provider = google
	limit = 10000
    config {
    }

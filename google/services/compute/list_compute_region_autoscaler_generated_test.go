...
func TestAccComputeRegionAutoscalerListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_region_autoscaler.foobar",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeRegionAutoscaler_regionAutoscalerBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_region_autoscaler.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_region_autoscaler.list_query",

...
func TestAccComputeRegionDiskListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeRegionDisk_regionDiskBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_region_disk.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_region_disk.list_query",
...
func testAccComputeRegionDisk_regionDiskBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_region_disk" "list_query" {
    provider = google
	limit = 10000
    config {
    }

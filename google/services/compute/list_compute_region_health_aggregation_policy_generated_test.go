...
func TestAccComputeRegionHealthAggregationPolicyListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_region_health_aggregation_policy.example_test_health_aggregation_policy",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeRegionHealthAggregationPolicy_computeRegionHealthAggregationPolicyBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_region_health_aggregation_policy.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_region_health_aggregation_policy.list_query",

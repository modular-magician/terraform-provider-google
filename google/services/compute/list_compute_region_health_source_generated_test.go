...
func TestAccComputeRegionHealthSourceListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_region_health_source.example_test_health_source",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeRegionHealthSource_computeRegionHealthSourceBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_region_health_source.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_region_health_source.list_query",

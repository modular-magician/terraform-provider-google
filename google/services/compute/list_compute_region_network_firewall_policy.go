...
func init() {
	registry.FrameworkListResource{
		...
		ProductName: "Compute",
		Func:        NewComputeRegionNetworkFirewallPolicyListResource,
	}.Register()
}

var _ list.ListResource = &ComputeRegionNetworkFirewallPolicyListResource{}

type ComputeRegionNetworkFirewallPolicyListResource struct {
	tpgresource.ListResourceMetadata
}

func NewComputeRegionNetworkFirewallPolicyListResource() list.ListResource {
	listR := &ComputeRegionNetworkFirewallPolicyListResource{}
	listR.TypeName = "google_compute_region_network_firewall_policy"
	listR.SDKv2Resource = ResourceComputeRegionNetworkFirewallPolicy()
...
// ComputeRegionNetworkFirewallPolicyListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type ComputeRegionNetworkFirewallPolicyListModel struct {
	Region  types.String `tfsdk:"region"`
	Project types.String `tfsdk:"project"`
}

func (listR *ComputeRegionNetworkFirewallPolicyListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data ComputeRegionNetworkFirewallPolicyListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListComputeRegionNetworkFirewallPolicys(
			listR.Client,
			region,
			project,
...
func ListComputeRegionNetworkFirewallPolicys(config *transport_tpg.Config,
	region string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceComputeRegionNetworkFirewallPolicy().Data(&terraform.InstanceState{})
	if region != "" {
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceComputeRegionNetworkFirewallPolicy(),
		ListURL:        url,

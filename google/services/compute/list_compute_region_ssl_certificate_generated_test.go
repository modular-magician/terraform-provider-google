...
func TestAccComputeRegionSslCertificateListQuery_generated(t *testing.T) {
	t.Parallel()
	acctest.SkipIfVcr(t)
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeRegionSslCertificate_regionSslCertificateBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_region_ssl_certificate.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_region_ssl_certificate.list_query",
...
func testAccComputeRegionSslCertificate_regionSslCertificateBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_region_ssl_certificate" "list_query" {
    provider = google
	limit = 10000
    config {
    }

...
func TestAccComputeRegionSslPolicyListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_region_ssl_policy.region-ssl-policy",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeRegionSslPolicy_regionSslPolicyBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_region_ssl_policy.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_region_ssl_policy.list_query",
...
func testAccComputeRegionSslPolicy_regionSslPolicyBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_region_ssl_policy" "list_query" {
    provider = google
	limit = 10000
    config {
    }

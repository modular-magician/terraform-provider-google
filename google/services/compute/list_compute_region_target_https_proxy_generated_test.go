...
func TestAccComputeRegionTargetHttpsProxyListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeRegionTargetHttpsProxy_regionTargetHttpsProxyBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_region_target_https_proxy.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_region_target_https_proxy.list_query",
...
func testAccComputeRegionTargetHttpsProxy_regionTargetHttpsProxyBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_region_target_https_proxy" "list_query" {
    provider = google
	limit = 10000
    config {
    }

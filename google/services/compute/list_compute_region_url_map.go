...
func init() {
	registry.FrameworkListResource{
		...
		ProductName: "Compute",
		Func:        NewComputeRegionUrlMapListResource,
	}.Register()
}

var _ list.ListResource = &ComputeRegionUrlMapListResource{}

type ComputeRegionUrlMapListResource struct {
	tpgresource.ListResourceMetadata
}

func NewComputeRegionUrlMapListResource() list.ListResource {
	listR := &ComputeRegionUrlMapListResource{}
	listR.TypeName = "google_compute_region_url_map"
	listR.SDKv2Resource = ResourceComputeRegionUrlMap()
...
// ComputeRegionUrlMapListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type ComputeRegionUrlMapListModel struct {
	Region  types.String `tfsdk:"region"`
	Project types.String `tfsdk:"project"`
}

func (listR *ComputeRegionUrlMapListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data ComputeRegionUrlMapListModel
...
func ListComputeRegionUrlMaps(config *transport_tpg.Config,
	region string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceComputeRegionUrlMap().Data(&terraform.InstanceState{})
	if region != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{ComputeBasePath}}projects/{{project}}/regions/{{region}}/urlMaps")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceComputeRegionUrlMap(),
		ListURL:        url,

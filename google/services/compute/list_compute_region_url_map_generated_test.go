...
func TestAccComputeRegionUrlMapListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeRegionUrlMap_regionUrlMapBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_region_url_map.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_region_url_map.list_query",

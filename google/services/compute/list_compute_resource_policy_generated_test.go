...
func TestAccComputeResourcePolicyListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_resource_policy.foo",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeResourcePolicy_resourcePolicyBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_resource_policy.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_resource_policy.list_query",
...
func testAccComputeResourcePolicy_resourcePolicyBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_resource_policy" "list_query" {
    provider = google
	limit = 10000
    config {
    }

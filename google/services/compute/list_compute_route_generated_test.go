...
func TestAccComputeRouteListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeRoute_routeBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_route.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_route.list_query",
...
func testAccComputeRoute_routeBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_route" "list_query" {
    provider = google
	limit = 10000
    config {
    }

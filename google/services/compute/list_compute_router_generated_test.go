...
func TestAccComputeRouterListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeRouter_routerBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_router.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_router.list_query",
...
func testAccComputeRouter_routerBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_router" "list_query" {
    provider = google
	limit = 10000
    config {
    }

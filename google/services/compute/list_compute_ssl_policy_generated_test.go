...
func TestAccComputeSslPolicyListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_ssl_policy.prod-ssl-policy",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeSslPolicy_sslPolicyBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_ssl_policy.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_ssl_policy.list_query",
...
func testAccComputeSslPolicy_sslPolicyBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_ssl_policy" "list_query" {
    provider = google
	limit = 10000
    config {
    }

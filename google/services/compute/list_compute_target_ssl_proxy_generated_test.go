...
func TestAccComputeTargetSslProxyListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeTargetSslProxy_targetSslProxyBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_target_ssl_proxy.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_target_ssl_proxy.list_query",

...
func TestAccComputeVpnTunnelListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeVpnTunnel_vpnTunnelBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_vpn_tunnel.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_vpn_tunnel.list_query",
...
func testAccComputeVpnTunnel_vpnTunnelBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_vpn_tunnel" "list_query" {
    provider = google
	limit = 10000
    config {
    }

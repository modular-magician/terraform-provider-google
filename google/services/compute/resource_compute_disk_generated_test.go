	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"architecture", "disk_encryption_key.0.raw_key_wo_version", "disk_encryption_key.0.rsa_encrypted_key_wo_version", "labels", "params", "snapshot", "source_storage_object", "terraform_labels", "type", "zone"},
			},
		},
	})
}

	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"architecture", "disk_encryption_key.0.raw_key_wo", "disk_encryption_key.0.raw_key_wo_version", "disk_encryption_key.0.rsa_encrypted_key_wo", "disk_encryption_key.0.rsa_encrypted_key_wo_version", "labels", "params", "snapshot", "source_storage_object", "terraform_labels", "type", "zone"},
			},
			{
				ResourceName:       "google_compute_disk.default",
				RefreshState:       true,
...
func TestAccComputeDisk_diskRsaEncryptedKeyWoExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeDisk_diskRsaEncryptedKeyWoExample(context),
			},
			{
				ResourceName:            "google_compute_disk.default",
				ImportState:             true,
...
func testAccComputeDisk_diskRsaEncryptedKeyWoExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_compute_disk" "default" {
  name  = "%{disk_name}"
  type  = "pd-ssd"

	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"update_strategy": {
				Type:         schema.TypeString,
				Optional:     true,
				ValidateFunc: verify.ValidateEnum([]string{"CONSENSUS", "INDEPENDENT"}),
				Description:  `Update strategy of the peering. The default value is INDEPENDENT. Possible values: ["INDEPENDENT", "CONSENSUS"]`,
				Default:      "INDEPENDENT",
			},
		},
		UseJSONNumber: true,

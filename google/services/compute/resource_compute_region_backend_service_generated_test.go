...
func TestAccComputeRegionBackendService_regionBackendServiceInternalSelfManagedLbSchemeExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeRegionBackendService_regionBackendServiceInternalSelfManagedLbSchemeExample(context),
			},
			{
				ResourceName:            "google_compute_region_backend_service.default",
				ImportState:             true,
...
func testAccComputeRegionBackendService_regionBackendServiceInternalSelfManagedLbSchemeExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_compute_region_backend_service" "default" {
  name                            = "tf-test-region-service%{random_suffix}"
  region                          = "us-central1"

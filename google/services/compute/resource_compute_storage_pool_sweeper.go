...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/compute/resource_compute_storage_pool_sweeper.go
//
...
func init() {
	sweeper.AddTestSweepersLegacy("ComputeStoragePool", testSweepStoragePool)
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepStoragePool(region string) error {
	resourceName := "ComputeStoragePool"
	...
	for _, zone := range zones {
		servicesUrl := "https://compute.googleapis.com/compute/v1/projects/" + config.Project + "/zones/" + zone + "/storagePools"

...
func init() {
	sweeper.AddTestSweepers("ComputeStoragePool", testSweepComputeStoragePool)
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepComputeStoragePool(region string) error {
	...
	listTemplate := strings.Split("https://compute.googleapis.com/compute/v1/projects/{{project}}/aggregated/storagePools", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://compute.googleapis.com/compute/v1/projects/{{project}}/zones/{{zone}}/storagePools/{{name}}"
		if obj["zone"] == nil {

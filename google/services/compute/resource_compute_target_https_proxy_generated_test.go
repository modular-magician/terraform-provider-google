...
func TestAccComputeTargetHttpsProxy_targetHttpsProxyGlobalCertificateManagerExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeTargetHttpsProxy_targetHttpsProxyGlobalCertificateManagerExample(context),
			},
			{
				ResourceName:            "google_compute_target_https_proxy.default",
				ImportState:             true,
...
func testAccComputeTargetHttpsProxy_targetHttpsProxyGlobalCertificateManagerExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_compute_target_https_proxy" "default" {
  name             = "tf-test-test-proxy%{random_suffix}"
  url_map          = google_compute_url_map.default.id

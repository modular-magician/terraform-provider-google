...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/config/resource_config_deployment_group_test.go
//
...
func TestAccConfigDeploymentGroup_policyError(t *testing.T) {
	t.Parallel()

...
func (w *ContactCenterInsightsOperationWaiter) QueryOp() (interface{}, error) {
	...
	url := fmt.Sprintf("%s%s", w.Config.ContactCenterInsightsBasePath, w.CommonOperationWaiter.Op.Name)
...
func ContactCenterInsightsOperationWaitTimeWithResponse(config *transport_tpg.Config, op map[string]interface{}, response *map[string]interface{}, project, activity, userAgent string, timeout time.Duration) error {

...
func init() {
	registry.FrameworkListResource{
		...
		Func:        NewContactCenterInsightsAssessmentRuleListResource,
	}.Register()
}

var _ list.ListResource = &ContactCenterInsightsAssessmentRuleListResource{}

type ContactCenterInsightsAssessmentRuleListResource struct {
	tpgresource.ListResourceMetadata
}

func NewContactCenterInsightsAssessmentRuleListResource() list.ListResource {
	listR := &ContactCenterInsightsAssessmentRuleListResource{}
	listR.TypeName = "google_contact_center_insights_assessment_rule"
	listR.SDKv2Resource = ResourceContactCenterInsightsAssessmentRule()
...
// ContactCenterInsightsAssessmentRuleListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type ContactCenterInsightsAssessmentRuleListModel struct {
	Location types.String `tfsdk:"location"`
	Project  types.String `tfsdk:"project"`
}

func (listR *ContactCenterInsightsAssessmentRuleListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data ContactCenterInsightsAssessmentRuleListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListContactCenterInsightsAssessmentRules(
			listR.Client,
			location,
			project,
...
func ListContactCenterInsightsAssessmentRules(config *transport_tpg.Config,
	location string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceContactCenterInsightsAssessmentRule().Data(&terraform.InstanceState{})
	if location != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{ContactCenterInsightsBasePath}}projects/{{project}}/locations/{{location}}/assessmentRules")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceContactCenterInsightsAssessmentRule(),
		ListURL:        url,
		BillingProject: billingProject,
		UserAgent:      userAgent,
		ItemName:       "assessmentRules",

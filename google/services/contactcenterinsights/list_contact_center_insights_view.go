...
func init() {
	registry.FrameworkListResource{
		...
		Func:        NewContactCenterInsightsViewListResource,
	}.Register()
}

var _ list.ListResource = &ContactCenterInsightsViewListResource{}

type ContactCenterInsightsViewListResource struct {
	tpgresource.ListResourceMetadata
}

func NewContactCenterInsightsViewListResource() list.ListResource {
	listR := &ContactCenterInsightsViewListResource{}
	listR.TypeName = "google_contact_center_insights_view"
	listR.SDKv2Resource = ResourceContactCenterInsightsView()
...
// ContactCenterInsightsViewListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type ContactCenterInsightsViewListModel struct {
	Location types.String `tfsdk:"location"`
	Project  types.String `tfsdk:"project"`
}

func (listR *ContactCenterInsightsViewListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data ContactCenterInsightsViewListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListContactCenterInsightsViews(
			listR.Client,
			location,
			project,
...
func ListContactCenterInsightsViews(config *transport_tpg.Config,
	location string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceContactCenterInsightsView().Data(&terraform.InstanceState{})
	if location != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{ContactCenterInsightsBasePath}}projects/{{project}}/locations/{{location}}/views")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceContactCenterInsightsView(),
		ListURL:        url,
		...
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err = ResourceContactCenterInsightsViewFlatten(d, config, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}

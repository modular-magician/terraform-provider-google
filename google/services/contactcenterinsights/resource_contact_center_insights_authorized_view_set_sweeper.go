...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionContactCenterInsightsAuthorizedViewSet,
		DeleteFunction: testSweepContactCenterInsightsAuthorizedViewSet,
	}
...
func testSweepContactCenterInsightsAuthorizedViewSet(_ string) error {
	return listAndActionContactCenterInsightsAuthorizedViewSet(deleteResourceContactCenterInsightsAuthorizedViewSet)
}

func listAndActionContactCenterInsightsAuthorizedViewSet(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ContactCenterInsightsAuthorizedViewSet"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/authorizedViewSets", "?")[0]
		...
		resourceList, ok := res["authorizedViewSets"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'authorizedViewSets'")
		} else {
...
func deleteResourceContactCenterInsightsAuthorizedViewSet(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/authorizedViewSets/{{authorized_view_set_id}}"

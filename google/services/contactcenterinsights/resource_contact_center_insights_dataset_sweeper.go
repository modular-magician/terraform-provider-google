...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionContactCenterInsightsDataset,
		DeleteFunction: testSweepContactCenterInsightsDataset,
	}
...
func testSweepContactCenterInsightsDataset(_ string) error {
	return listAndActionContactCenterInsightsDataset(deleteResourceContactCenterInsightsDataset)
}

func listAndActionContactCenterInsightsDataset(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ContactCenterInsightsDataset"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/datasets", "?")[0]
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'datasets'")
		} else {
...
func deleteResourceContactCenterInsightsDataset(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/datasets/{{dataset_id}}"

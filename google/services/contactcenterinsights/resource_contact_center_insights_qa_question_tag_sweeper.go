...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionContactCenterInsightsQaQuestionTag,
		DeleteFunction: testSweepContactCenterInsightsQaQuestionTag,
	}
...
func testSweepContactCenterInsightsQaQuestionTag(_ string) error {
	return listAndActionContactCenterInsightsQaQuestionTag(deleteResourceContactCenterInsightsQaQuestionTag)
}

func listAndActionContactCenterInsightsQaQuestionTag(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ContactCenterInsightsQaQuestionTag"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/qaQuestionTags", "?")[0]
		...
		resourceList, ok := res["qaQuestionTags"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'qaQuestionTags'")
		} else {
...
func deleteResourceContactCenterInsightsQaQuestionTag(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/qaQuestionTags/{{qa_question_tag_id}}"

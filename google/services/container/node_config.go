...
func flattenNodeConfig(c *container.NodeConfig, v interface{}, d *schema.ResourceData, prefix string) []map[string]interface{} {
	...
	config = append(config, map[string]interface{}{
		...
		"labels":                             c.Labels,
		"resource_labels":                    flattenNodeConfigResourceLabels(c.ResourceLabels, d, prefix+".0.resource_labels"),
		"terraform_labels":                   flattenNodeConfigResourceLabels(c.ResourceLabels, d, prefix+".0.terraform_labels"),
		"effective_resource_labels":          c.ResourceLabels,
		"tags":                               c.Tags,
...
func flattenNodeConfigResourceLabels(v interface{}, d *schema.ResourceData, rLabels string) interface{} {
	if v == nil {
		return v
	}

	transformed := make(map[string]string)
	if l, ok := d.GetOkExists(rLabels); ok {

...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/container/resource_container_cluster_migratev1.go.tmpl
//
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"enable_components": {
							...
							Optional:    true,
							Computed:    true,
							Description: `GKE components exposing metrics. Valid values include SYSTEM_COMPONENTS, APISERVER, SCHEDULER, CONTROLLER_MANAGER, STORAGE, HPA, POD, DAEMONSET, DEPLOYMENT, STATEFULSET, DCGM and JOBSET.`,
							Elem: &schema.Schema{
								Type: schema.TypeString,
							},
						},

...
func TestAccContainerCluster_withControlPlaneEgress(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerCluster_withControlPlaneEgress(clusterName, networkName, subnetworkName, "NONE"),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("google_container_cluster.primary", "control_plane_egress.0.mode", "NONE"),
				),
			},
			{
				ResourceName:            "google_container_cluster.primary",
			...
			{
				Config: testAccContainerCluster_withControlPlaneEgress(clusterName, networkName, subnetworkName, "VIA_CONTROL_PLANE"),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("google_container_cluster.primary", "control_plane_egress.0.mode", "VIA_CONTROL_PLANE"),
				),
			},
			{
				ResourceName:            "google_container_cluster.primary",
...
func testAccContainerCluster_withControlPlaneEgress(name, networkName, subnetworkName string, mode string) string {
	return fmt.Sprintf(`
resource "google_container_cluster" "primary" {
  name                = "%s"
  network             = "%s"

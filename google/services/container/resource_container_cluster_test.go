...
func TestAccContainerCluster_withComplianceConfig(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:            "google_container_cluster.with_compliance_config",
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"deletion_protection"},
			},
			{
				Config:      testAccContainerCluster_UpdateToEmptyStandardNotAllowed(clusterName, networkName, subnetworkName),
				ExpectError: regexp.MustCompile(`Missing required argument`),
			},
			{
				Config:      testAccContainerCluster_UpdateToRepeatedStandardNotAllowed(clusterName, networkName, subnetworkName),
				ExpectError: regexp.MustCompile(`Duplicate compliance standard .* found`),
			},
			{
				Config: testAccContainerCluster_UpdateComplianceConfigToExplicitStandards(clusterName, networkName, subnetworkName),
			},
			{
				ResourceName:            "google_container_cluster.with_compliance_config",
				ImportState:             true,
			...
			{
				Config: testAccContainerCluster_DisableComplianceConfig(clusterName, networkName, subnetworkName),
			},
			{
				ResourceName:            "google_container_cluster.with_compliance_config",
				ImportState:             true,
...
func testAccContainerCluster_EnableComplianceConfigWithDefaultStandards(resource_name, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
resource "google_container_cluster" "with_compliance_config" {
  name               = "%s"
  location           = "us-central1-a"
  initial_node_count = 1
  compliance_config {
...
func testAccContainerCluster_UpdateComplianceConfigToExplicitStandards(resource_name, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
resource "google_container_cluster" "with_compliance_config" {
  name               = "%s"
  location           = "us-central1-a"
...
func testAccContainerCluster_UpdateToEmptyStandardNotAllowed(resource_name, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
resource "google_container_cluster" "with_compliance_config" {
  name               = "%s"
  location           = "us-central1-a"
...
func testAccContainerCluster_UpdateToRepeatedStandardNotAllowed(resource_name, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
resource "google_container_cluster" "with_compliance_config" {
  name               = "%s"
  location           = "us-central1-a"
...
func testAccContainerCluster_DisableComplianceConfig(resource_name, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
resource "google_container_cluster" "with_compliance_config" {
  name               = "%s"
  location           = "us-central1-a"

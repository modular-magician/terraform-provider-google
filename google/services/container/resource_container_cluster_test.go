...
func TestAccContainerCluster_auto_ip_address_management(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerCluster_auto_ip_address_management(clusterName, true),
			},
			{
				ResourceName:            "google_container_cluster.primary",
				ImportState:             true,
			...
			{
				Config: testAccContainerCluster_auto_ip_address_management(clusterName, false),
			},
			{
				ResourceName:            "google_container_cluster.primary",
				ImportState:             true,
...
func testAccContainerCluster_auto_ip_address_management(clusterName string, autoIpam bool) string {
	return fmt.Sprintf(`
resource "google_compute_network" "default" {
  name                    = "%s"
  auto_create_subnetworks = false
...
`, clusterName, clusterName, autoIpam)
}

...
func TestAccContainerCluster_withNodeConfigLinuxNodeConfig(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccContainerCluster_withNodeConfigLinuxNodeConfigDiskIoScheduler(clusterName, networkName, subnetworkName, "bfq", "mq-deadline"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"google_container_cluster.with_linux_node_config",
			...
			{
				Config: testAccContainerCluster_withNodeConfigLinuxNodeConfigNodeVfioConfig(clusterName, networkName, subnetworkName, 100000),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"google_container_cluster.with_linux_node_config",
...
func testAccContainerCluster_withNodeConfigLinuxNodeConfigDiskIoScheduler(clusterName, networkName, subnetworkName, sysScheduler, attachedScheduler string) string {
	return fmt.Sprintf(`
data "google_container_engine_versions" "central1a" {
  location = "us-central1-a"
}
...
`, clusterName, sysScheduler, attachedScheduler, networkName, subnetworkName)
}

func testAccContainerCluster_withNodeConfigLinuxNodeConfigNodeVfioConfig(clusterName, networkName, subnetworkName string, dmaEntryLimit int) string {
	return fmt.Sprintf(`
data "google_container_engine_versions" "central1a" {
  location = "us-central1-a"
}
...
`, clusterName, dmaEntryLimit, networkName, subnetworkName)
}

...
func TestAccContainerCluster_networkingModeRoutes(t *testing.T) {
	...
	subnetworkName := tpgcompute.BootstrapSubnetInRegion(t, "gke-cluster-moderoutes", networkName, "us-east1", "10.79.0.0/20")
...
func TestAccContainerCluster_withConfidentialNodes(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerCluster_withConfidentialNodes(clusterName, npName, networkName, subnetworkName, false, "", "c4d-standard-4"),
			},
			{
			...
			{
				Config: testAccContainerCluster_withConfidentialNodes(clusterName, npName, networkName, subnetworkName, true, "", "c4d-standard-4"),
			},
			{
				ResourceName:            "google_container_cluster.confidential_nodes",
				ImportState:             true,
			...
			{
				Config: testAccContainerCluster_withConfidentialNodes(clusterName, npName, networkName, subnetworkName, false, "SEV", "c4d-standard-4"),
			},
			{
				ResourceName:            "google_container_cluster.confidential_nodes",
				ImportState:             true,
...
// Secondary Network (Required for Manual Config)
...
func testAccContainerCluster_nodePool_acceleratorNetworkProfile_basic(clusterName string) string {
	return fmt.Sprintf(`
resource "google_compute_network" "main_net" {
  name                    = "%[1]s-main-net"
  auto_create_subnetworks = false
...
func testAccContainerCluster_nodePool_acceleratorNetworkProfile_auto(clusterName string) string {
	return fmt.Sprintf(`
resource "google_compute_network" "main_net" {
  name                    = "%[1]s-main-net"
  auto_create_subnetworks = false
...
resource "google_container_cluster" "primary" {
  ...
  node_pool {
	...
	// Enabling Flex Start
    queued_provisioning { enabled = true }
    autoscaling {
      min_node_count = 0
      max_node_count = 1
    }
...
func TestAccContainerCluster_nodePool_acceleratorNetworkProfile_Lifecycle(t *testing.T) {
	t.Parallel()

	clusterName := fmt.Sprintf("tf-test-cluster-%s", acctest.RandString(t, 10))
	resourceName := "google_container_cluster.primary"
	importIgnore := []string{"deletion_protection", "terraform_labels", "initial_node_count"}
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccContainerCluster_nodePool_additionalNodeNetworkConfigs_manual(clusterName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "name", clusterName),
					// Verify manual config exists
					resource.TestCheckResourceAttr(resourceName, "node_pool.0.network_config.0.additional_node_network_configs.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "node_pool.0.network_config.0.accelerator_network_profile", ""),
				),
			},
			{
				ResourceName:            resourceName,
			...
			// Step 2: Remove Manual Config (Expect Replacement)
			{
				...
				Check: resource.ComposeTestCheckFunc(
					// Verify additional configs are gone
					resource.TestCheckResourceAttr(resourceName, "node_pool.0.network_config.0.additional_node_network_configs.#", "0"),
					resource.TestCheckResourceAttr(resourceName, "node_pool.0.network_config.0.accelerator_network_profile", ""),
				),
			},
			{
			...
			{
				Config: testAccContainerCluster_nodePool_acceleratorNetworkProfile_auto(clusterName),
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
						plancheck.ExpectResourceAction(resourceName, plancheck.ResourceActionReplace),
					},
...
func TestAccContainerCluster_withSlurmOperatorConfig(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerCluster_switchSlurmOperator(clusterName, networkName, subnetworkName, true),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("google_container_cluster.with_slurm_config", "addons_config.0.slurm_operator_config.0.enabled", "true"),
				),
			},
			{
				ResourceName:            "google_container_cluster.with_slurm_config",
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"deletion_protection"},
			},
			{
				Config: testAccContainerCluster_switchSlurmOperator(clusterName, networkName, subnetworkName, false),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("google_container_cluster.with_slurm_config", "addons_config.0.slurm_operator_config.0.enabled", "false"),
				),
			},
			{
				ResourceName:            "google_container_cluster.with_slurm_config",
...
func testAccContainerCluster_switchSlurmOperator(clusterName, networkName, subnetworkName string, enabled bool) string {
	return fmt.Sprintf(`

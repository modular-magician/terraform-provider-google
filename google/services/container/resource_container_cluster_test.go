		...
		Steps: []resource.TestStep{
			{
				...
				ExpectError: regexp.MustCompile(`expected cluster_network_performance_config\.0\.total_egress_bandwidth_tier to be one of \[TIER_UNSPECIFIED TIER_1\], got TEST_TIER`),
			},
			{

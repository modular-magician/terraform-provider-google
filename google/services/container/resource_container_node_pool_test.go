...
func TestAccContainerNodePool_withConfidentialNodes(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerNodePool_withConfidentialNodes(clusterName, np, networkName, subnetworkName, false, "", "c4d-standard-4"),
			},
			{
				ResourceName:      "google_container_node_pool.np",
				ImportState:       true,
			...
			{
				Config: testAccContainerNodePool_withConfidentialNodes(clusterName, np, networkName, subnetworkName, true, "", "c4d-standard-4"),
			},
			{
				ResourceName:      "google_container_node_pool.np",
				ImportState:       true,
			...
			{
				Config: testAccContainerNodePool_withConfidentialNodes(clusterName, np, networkName, subnetworkName, false, "SEV", "c4d-standard-4"),
			},
			{
				ResourceName:      "google_container_node_pool.np",
				ImportState:       true,

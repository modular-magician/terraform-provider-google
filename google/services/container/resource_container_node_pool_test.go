...
func TestAccContainerNodePool_withGPU(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerNodePool_withGPU(cluster, np, networkName, subnetworkName, "LATEST"),
			},
			{
			...
			{
				Config: testAccContainerNodePool_withGPU(cluster, np, networkName, subnetworkName, "DEFAULT"),
			},
			{
				ResourceName:      "google_container_node_pool.np_with_gpu",
				ImportState:       true,
...
func testAccContainerNodePool_withGPU(cluster, np, networkName, subnetworkName, version string) string {
	return fmt.Sprintf(`
...
`, cluster, networkName, subnetworkName, np, version)
}

...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/container/resource_container_node_pool_test.go.tmpl
//
...
func TestAccContainerNodePool_withNodeConfigWithBootDiskConfig(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerNodePool_withBootDisk(cluster, nodePool, networkName, subnetworkName),
			},
			{
				ResourceName:      "google_container_node_pool.np",
				ImportState:       true,
			...
			{
				Config: testAccContainerNodePool_withBootDiskUpdate(cluster, nodePool, networkName, subnetworkName),
			},
			{
				ResourceName:      "google_container_node_pool.np",
				ImportState:       true,
...
func TestAccContainerNodePool_withNodeConfigWithBootDiskConfigChangeType(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccContainerNodePool_withBootDiskTypeChangeUpdate(cluster, nodePool, networkName, subnetworkName),
			},
			{
				ResourceName:      "google_container_node_pool.np",
				ImportState:       true,
...
func TestAccContainerNodePool_withNodeConfigWithBootDiskConfigChangeTypeLegacy(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccContainerNodePool_withLegacyBootDiskTypeSize(cluster, nodePool, networkName, subnetworkName),
			},
			{
				ResourceName:      "google_container_node_pool.np",
				ImportState:       true,
...
func TestAccContainerNodePool_withLegacyNodeConfigAndBootDiskUpdate(t *testing.T) {
	// Ensure that the legacy configuration (top level of node_config) can be updated to the new configuration (in boot_disk).
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccContainerNodePool_withLegacyBootDiskTypeSizeUpdateNew(cluster, nodePool, networkName, subnetworkName),
			},
			{
				ResourceName:      "google_container_node_pool.np",
				ImportState:       true,
...
func testAccContainerNodePool_withBootDisk(cluster, np, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
provider "google" {
...
func testAccContainerNodePool_withBootDiskUpdate(cluster, np, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
provider "google" {
  alias                 = "user-project-override"
  user_project_override = true
...
// Checks to ensure that boot disk type can be moved off of hyperdisk-balanced.
func testAccContainerNodePool_withBootDiskTypeChangeUpdate(cluster, np, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
provider "google" {
  alias                 = "user-project-override"
  user_project_override = true
...
// Checks to ensure legacy boot disk type and size can be used.
func testAccContainerNodePool_withLegacyBootDiskTypeSize(cluster, np, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
provider "google" {
  alias                 = "user-project-override"
  user_project_override = true
...
// Used to check that legacy -> new updates work.
func testAccContainerNodePool_withLegacyBootDiskTypeSizeUpdateNew(cluster, np, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
provider "google" {
  alias                 = "user-project-override"
  user_project_override = true
...
func TestAccContainerNodePool_withSandboxConfigType(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerNodePool_withSandboxConfigType(cluster, np, networkName, subnetworkName),
			},
			{
...
func TestAccContainerNodePool_withLinuxNodeConfig(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Update node disk io scheduler config
			{
				Config: testAccContainerNodePool_withLinuxNodeConfigDiskIoScheduler(cluster, np, "bfq", "mq-deadline", networkName, subnetworkName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"google_container_node_pool.with_linux_node_config",
						"node_config.0.linux_node_config.0.disk_io_scheduler.0.node_system_io_scheduler", "bfq",
					),
					resource.TestCheckResourceAttr(
						"google_container_node_pool.with_linux_node_config",
						"node_config.0.linux_node_config.0.disk_io_scheduler.0.node_attached_disk_io_scheduler", "mq-deadline",
					),
				),
			},
			{
			...
			// Update node vfio config
			{
				Config: testAccContainerNodePool_withLinuxNodeConfigNodeVfioConfig(cluster, np, 100000, networkName, subnetworkName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"google_container_node_pool.with_linux_node_config",
						"node_config.0.linux_node_config.0.node_vfio_config.0.dma_entry_limit", "100000",
					),
				),
			},
			{
...
func testAccContainerNodePool_withLinuxNodeConfigDiskIoScheduler(cluster, np, sysScheduler, attachedScheduler, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
data "google_container_engine_versions" "central1a" {
  location = "us-central1-a"
}
...
resource "google_container_node_pool" "with_linux_node_config" {
  ...
  node_config {
    ...
    linux_node_config {
      disk_io_scheduler {
        node_system_io_scheduler        = "%s"
        node_attached_disk_io_scheduler = "%s"
      }
    }
    oauth_scopes = [
      "https://www.googleapis.com/auth/logging.write",
...
`, cluster, networkName, subnetworkName, np, sysScheduler, attachedScheduler)
}

func testAccContainerNodePool_withLinuxNodeConfigNodeVfioConfig(cluster, np string, dmaEntryLimit int, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
data "google_container_engine_versions" "central1a" {
  location = "us-central1-a"
}
...
`, cluster, networkName, subnetworkName, np, dmaEntryLimit)
}
...
func TestAccContainerNodePool_withCustomNodeInit(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerNodePool_withCustomNodeInit(cluster, nodePool, bucketName, networkName, subnetworkName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("google_container_node_pool.np_with_custom_node_init", "node_config.0.linux_node_config.0.custom_node_init.0.init_script.0.gcs_uri", fmt.Sprintf("gs://%s/script.sh", bucketName)),
					resource.TestCheckResourceAttrSet("google_container_node_pool.np_with_custom_node_init", "node_config.0.linux_node_config.0.custom_node_init.0.init_script.0.gcs_generation"),
				),
			},
			{
				ResourceName:            "google_container_node_pool.np_with_custom_node_init",
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"initial_node_count", "cluster"},
			},
		},
	})
}
...
`, bucket, cluster, networkName, subnetworkName, np)
}

func TestAccContainerNodePool_withCustomNodeInitSecret(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerNodePool_withCustomNodeInitSecret(cluster, nodePool, secretId, networkName, subnetworkName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("google_container_node_pool.np_with_custom_node_init_secret", "node_config.0.linux_node_config.0.custom_node_init.0.init_script.0.gcp_secret_manager_secret_uri"),
				),
			},
			{
				ResourceName:            "google_container_node_pool.np_with_custom_node_init_secret",
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"initial_node_count", "cluster"},
			},

...
func TestAccContainerNodePool_withClusterBootDisk(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerNodePool_withClusterBootDisk(cluster, networkName, subnetworkName),
			},
			{
			...
			{
				Config: testAccContainerNodePool_withClusterBootDiskUpdate(cluster, networkName, subnetworkName),
			},
			{
				ResourceName:            "google_container_cluster.cluster",
				ImportState:             true,
...
func testAccContainerNodePool_withClusterBootDisk(cluster, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
provider "google" {
...
func testAccContainerNodePool_withClusterBootDiskUpdate(cluster, networkName, subnetworkName string) string {
	return fmt.Sprintf(`
provider "google" {
  alias                 = "user-project-override"
  user_project_override = true
...
func TestAccContainerNodePool_withTransparentHugepage(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerNodePool_withTransparentHugepage(cluster, np, networkName, subnetworkName, "TRANSPARENT_HUGEPAGE_ENABLED_NEVER", "TRANSPARENT_HUGEPAGE_DEFRAG_NEVER"),
			},
			{
				ResourceName:      "google_container_node_pool.np",
				ImportState:       true,
			...
			// Perform an update.
			{
				Config: testAccContainerNodePool_withTransparentHugepage(cluster, np, networkName, subnetworkName, "TRANSPARENT_HUGEPAGE_ENABLED_ALWAYS", "TRANSPARENT_HUGEPAGE_DEFRAG_ALWAYS"),
			},
			{
				ResourceName:      "google_container_node_pool.np",
				ImportState:       true,
...
func testAccContainerNodePool_withTransparentHugepage(cluster, np, networkName, subnetworkName, hugepage, hugepageDefrag string) string {
	return fmt.Sprintf(`
data "google_container_engine_versions" "central1a" {
  location = "us-central1-a"
}
...
`, cluster, networkName, subnetworkName, np, hugepage, hugepageDefrag)
}

							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									...
									"organization_id": {
										Type:          schema.TypeString,
										Optional:      true,
										Description:   `The AWS organization ID that this discovery config applies to. Within an organization, you can find the AWS organization ID inside an AWS account ARN. Example: arn:<partition>:organizations::<management-account-id>:account/<organization-id>/<account-id>`,
										ConflictsWith: []string{},
									},
								},
							},
...
func flattenDataLossPreventionDiscoveryConfigOtherCloudStartingLocationAwsLocation(v interface{}, d *schema.ResourceData, config *transport_tpg.Config) interface{} {
	...
	transformed := make(map[string]interface{})
	transformed["organization_id"] =
		flattenDataLossPreventionDiscoveryConfigOtherCloudStartingLocationAwsLocationOrganizationId(original["organizationId"], d, config)
...
func flattenDataLossPreventionDiscoveryConfigOtherCloudStartingLocationAwsLocationOrganizationId(v interface{}, d *schema.ResourceData, config *transport_tpg.Config) interface{} {
	return v
}

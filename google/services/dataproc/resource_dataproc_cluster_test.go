...
func TestAccDataprocCluster_withResourceManagerTags(t *testing.T) {
	...
	networkName := acctest.BootstrapSharedTestNetwork(t, "dataproc-cluster-rmtags")
	subnetworkName := acctest.BootstrapSubnet(t, "dataproc-cluster-rmtags", networkName)
	acctest.BootstrapFirewallForDataprocSharedNetwork(t, "dataproc-cluster-rmtags", networkName)
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataprocCluster_withResourceManagerTags(projectId, randString, subnetworkName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDataprocClusterExists(t, "google_dataproc_cluster.basic", &cluster),
...
func testAccDataprocCluster_withResourceManagerTags(projectId, randString, subnet string) string {
	return fmt.Sprintf(`

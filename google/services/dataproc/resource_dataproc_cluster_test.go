...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/dataproc/resource_dataproc_cluster_test.go
//
...
gcloud alpha storage cp /tmp/%s ${google_storage_bucket.init_bucket.url}
EOL

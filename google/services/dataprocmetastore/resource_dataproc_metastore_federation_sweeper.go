...
func listAndActionDataprocMetastoreFederation(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://metastore.googleapis.com/v1/projects/{{project}}/locations/{{location}}/federations", "?")[0]
...
func deleteResourceDataprocMetastoreFederation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://metastore.googleapis.com/v1/projects/{{project}}/locations/{{location}}/federations/{{federation_id}}"

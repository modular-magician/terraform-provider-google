...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/datastream/datastream_operation.go
//
...
func (w *DatastreamOperationWaiter) QueryOp() (interface{}, error) {
	...
	url := fmt.Sprintf("%s%s", w.Config.BasePaths["datastream"], w.Op.Name)

		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_discovery_engine_assistant.basic",
						[]string{
							"name",
							"assistant_id",
						},
			...
			{
				Query:           true,
				Config:          testAccDiscoveryEngineAssistant_discoveryengineAssistantBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_discovery_engine_assistant.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_discovery_engine_assistant.list_query",
...
func testAccDiscoveryEngineAssistant_discoveryengineAssistantBasicExampleListQuery(context map[string]interface{}) string {

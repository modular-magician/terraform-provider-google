...
func TestAccDiscoveryEngineControlListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_discovery_engine_control.basic",
						[]string{
							"name",
							"control_id",
						},
					...
					listScope.Capture(map[string]string{
						"location":  "google_discovery_engine_control.basic",
						"engine_id": "google_discovery_engine_control.basic",
						"project":   "google_discovery_engine_control.basic",
					}),
				),
			},
			{
				Query:           true,
				Config:          testAccDiscoveryEngineControl_discoveryengineControlBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_discovery_engine_control.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_discovery_engine_control.list_query",
...
func testAccDiscoveryEngineControl_discoveryengineControlBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
variable "location" { type = string }
variable "engine_id" { type = string }
variable "project" { type = string }
list "google_discovery_engine_control" "list_query" {
    provider = google
	limit = 10000
    config {

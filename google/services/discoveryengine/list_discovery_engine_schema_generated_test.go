...
func TestAccDiscoveryEngineSchemaListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_discovery_engine_schema.basic",
						[]string{
							"name",
							"schema_id",
						},
					...
					listScope.Capture(map[string]string{
						"location":      "google_discovery_engine_schema.basic",
						"data_store_id": "google_discovery_engine_schema.basic",
						"project":       "google_discovery_engine_schema.basic",
					}),
				),
			},
			{
				Query:           true,
				Config:          testAccDiscoveryEngineSchema_discoveryengineSchemaBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_discovery_engine_schema.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_discovery_engine_schema.list_query",
...
func testAccDiscoveryEngineSchema_discoveryengineSchemaBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
variable "location" { type = string }
variable "data_store_id" { type = string }
variable "project" { type = string }
list "google_discovery_engine_schema" "list_query" {
    provider = google
	limit = 10000
    config {

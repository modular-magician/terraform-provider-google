...
func TestAccDiscoveryEngineSitemapListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_discovery_engine_sitemap.basic",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccDiscoveryEngineSitemap_discoveryengineSitemapBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_discovery_engine_sitemap.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_discovery_engine_sitemap.list_query",
...
func testAccDiscoveryEngineSitemap_discoveryengineSitemapBasicExampleListQuery(context map[string]interface{}) string {

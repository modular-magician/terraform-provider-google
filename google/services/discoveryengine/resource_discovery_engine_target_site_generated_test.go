...
func TestAccDiscoveryEngineTargetSite_discoveryengineTargetsiteSkipWaitExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDiscoveryEngineTargetSite_discoveryengineTargetsiteSkipWaitExample(context),
			},
			{
				ResourceName:            "google_discovery_engine_target_site.skip_wait",
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"data_store_id", "location", "project", "provided_uri_pattern", "skip_wait", "target_site_id"},
			},
			{
				ResourceName:       "google_discovery_engine_target_site.skip_wait",
				RefreshState:       true,
...
func testAccDiscoveryEngineTargetSite_discoveryengineTargetsiteSkipWaitExample(context map[string]interface{}) string {
	return acctest.Nprintf(`

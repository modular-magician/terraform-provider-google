...
func TestAccEdgecontainerCluster_edgecontainerClusterWithMaintenanceExclusionWindowsExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccEdgecontainerCluster_edgecontainerClusterWithMaintenanceExclusionWindowsExample(context),
			},
			{
				ResourceName:            "google_edgecontainer_cluster.default",
				ImportState:             true,
...
func testAccEdgecontainerCluster_edgecontainerClusterWithMaintenanceExclusionWindowsExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_edgecontainer_cluster" "default" {

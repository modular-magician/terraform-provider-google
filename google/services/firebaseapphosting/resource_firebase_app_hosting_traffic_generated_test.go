...
func testAccFirebaseAppHostingTraffic_firebaseAppHostingTrafficTargetExample(context map[string]interface{}) string {
...
func testAccFirebaseAppHostingTraffic_firebaseAppHostingTrafficRolloutPolicyExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_firebase_app_hosting_traffic" "example" {
  project          = google_firebase_app_hosting_backend.example.project
  location         = google_firebase_app_hosting_backend.example.location
...
func testAccFirebaseAppHostingTraffic_firebaseAppHostingTrafficRolloutPolicyDisabledExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_firebase_app_hosting_traffic" "example" {
  project          = google_firebase_app_hosting_backend.example.project
  location         = google_firebase_app_hosting_backend.example.location

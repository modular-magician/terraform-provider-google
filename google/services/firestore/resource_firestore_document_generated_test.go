...
func TestAccFirestoreDocument_firestoreDocumentVariousTypesExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccFirestoreDocument_firestoreDocumentVariousTypesExample(context),
			},
			{
				ResourceName:            "google_firestore_document.mydoc",
				ImportState:             true,
...
func testAccFirestoreDocument_firestoreDocumentVariousTypesExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_project" "project" {
  project_id = "tf-test-project-id%{random_suffix}"
  name       = "tf-test-project-id%{random_suffix}"
...
resource "google_firestore_document" "some_other_document" {
  ...
  database    = google_firestore_database.database.name
  collection  = "somenewcollection"
  document_id = "tf-test-other-doc-id%{random_suffix}"

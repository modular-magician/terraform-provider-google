...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionGeminiDataAnalyticsDataAgent,
		DeleteFunction: testSweepGeminiDataAnalyticsDataAgent,
	}
...
func testSweepGeminiDataAnalyticsDataAgent(_ string) error {
	return listAndActionGeminiDataAnalyticsDataAgent(deleteResourceGeminiDataAnalyticsDataAgent)
}

func listAndActionGeminiDataAnalyticsDataAgent(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "GeminiDataAnalyticsDataAgent"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://geminidataanalytics.googleapis.com/v1/projects/{{project}}/locations/{{location}}/dataAgents", "?")[0]
		...
		resourceList, ok := res["dataAgents"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'dataAgents'")
		} else {
...
func deleteResourceGeminiDataAnalyticsDataAgent(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://geminidataanalytics.googleapis.com/v1/projects/{{project}}/locations/{{location}}/dataAgents/{{data_agent_id}}:deleteSync"

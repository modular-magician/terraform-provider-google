...
func canonicalizeFeatureMembershipMesh(des, initial *FeatureMembershipMesh, opts ...dcl.ApplyOption) *FeatureMembershipMesh {
	...
	if dcl.IsZeroValue(des.ConfigApi) || (dcl.IsEmptyValueIndirect(des.ConfigApi) && dcl.IsEmptyValueIndirect(initial.ConfigApi)) {
		// Desired and initial values are equivalent, so set canonical desired value to initial value.
		cDes.ConfigApi = initial.ConfigApi
	} else {
		cDes.ConfigApi = des.ConfigApi
	}
...
func compareFeatureMembershipMeshNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	...
	if ds, err := dcl.Diff(desired.ConfigApi, actual.ConfigApi, dcl.DiffInfo{Type: "EnumType", OperationSelector: dcl.TriggersOperation("updateFeatureMembershipUpdateFeatureMembershipOperation")}, fn.AddNest("ConfigApi")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func expandFeatureMembershipMesh(c *Client, f *FeatureMembershipMesh, res *FeatureMembership) (map[string]interface{}, error) {
	...
	if v := f.ConfigApi; !dcl.IsEmptyValueIndirect(v) {
		m["configApi"] = v
	}
...
func flattenFeatureMembershipMesh(c *Client, i interface{}, res *FeatureMembership) *FeatureMembershipMesh {
	...
	r.ConfigApi = flattenFeatureMembershipMeshConfigApiEnum(m["configApi"])
...
// flattenFeatureMembershipMeshConfigApiEnumMap flattens the contents of FeatureMembershipMeshConfigApiEnum from a JSON
// response object.
func flattenFeatureMembershipMeshConfigApiEnumMap(c *Client, i interface{}, res *FeatureMembership) map[string]FeatureMembershipMeshConfigApiEnum {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]FeatureMembershipMeshConfigApiEnum{}
	}
	...
	items := make(map[string]FeatureMembershipMeshConfigApiEnum)
	for k, item := range a {
		items[k] = *flattenFeatureMembershipMeshConfigApiEnum(item.(interface{}))
	}

	return items
}

// flattenFeatureMembershipMeshConfigApiEnumSlice flattens the contents of FeatureMembershipMeshConfigApiEnum from a JSON
// response object.
func flattenFeatureMembershipMeshConfigApiEnumSlice(c *Client, i interface{}, res *FeatureMembership) []FeatureMembershipMeshConfigApiEnum {
	a, ok := i.([]interface{})
	if !ok {
		return []FeatureMembershipMeshConfigApiEnum{}
	}
	...
	items := make([]FeatureMembershipMeshConfigApiEnum, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenFeatureMembershipMeshConfigApiEnum(item.(interface{})))
	}

	return items
}

// flattenFeatureMembershipMeshConfigApiEnum asserts that an interface is a string, and returns a
// pointer to a *FeatureMembershipMeshConfigApiEnum with the same value as that string.
func flattenFeatureMembershipMeshConfigApiEnum(i interface{}) *FeatureMembershipMeshConfigApiEnum {
	s, ok := i.(string)
	if !ok {
		return nil
	}

	return FeatureMembershipMeshConfigApiEnumRef(s)
}

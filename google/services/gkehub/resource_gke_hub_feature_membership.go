...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/gkehub/resource_gke_hub_feature_membership.go.tmpl
//
	...
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"config_api": {
				Type:        schema.TypeString,
				Optional:    true,
				Description: "Whether to use istio or gateway api to configure Service Mesh. Possible values: CONFIG_API_UNSPECIFIED, CONFIG_API_ISTIO, CONFIG_API_GATEWAY",
			},
		},
	}
}
...
func expandGkeHubFeatureMembershipConfigmanagement(o interface{}) *FeatureMembershipConfigmanagement {
	if o == nil {
	...
	return &FeatureMembershipConfigmanagement{
		...
		Management:          FeatureMembershipConfigmanagementManagementEnumRef(obj["management"].(string)),
...
func flattenGkeHubFeatureMembershipConfigmanagement(obj *FeatureMembershipConfigmanagement) interface{} {
...
func expandGkeHubFeatureMembershipConfigmanagementConfigSync(o interface{}) *FeatureMembershipConfigmanagementConfigSync {
	if o == nil {
...
func flattenGkeHubFeatureMembershipConfigmanagementConfigSync(obj *FeatureMembershipConfigmanagementConfigSync) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesArray(o interface{}) []FeatureMembershipConfigmanagementConfigSyncDeploymentOverrides {
	if o == nil {
		return make([]FeatureMembershipConfigmanagementConfigSyncDeploymentOverrides, 0)
	}
	...
	items := make([]FeatureMembershipConfigmanagementConfigSyncDeploymentOverrides, 0, len(objs))
...
func expandGkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverrides(o interface{}) *FeatureMembershipConfigmanagementConfigSyncDeploymentOverrides {
	if o == nil {
...
func flattenGkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesArray(objs []FeatureMembershipConfigmanagementConfigSyncDeploymentOverrides) []interface{} {
	if objs == nil {
		return nil
	}
...
func flattenGkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverrides(obj *FeatureMembershipConfigmanagementConfigSyncDeploymentOverrides) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesContainersArray(o interface{}) []FeatureMembershipConfigmanagementConfigSyncDeploymentOverridesContainers {
	if o == nil {
		return make([]FeatureMembershipConfigmanagementConfigSyncDeploymentOverridesContainers, 0)
	}
	...
	items := make([]FeatureMembershipConfigmanagementConfigSyncDeploymentOverridesContainers, 0, len(objs))
	for _, item := range objs {
...
func expandGkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesContainers(o interface{}) *FeatureMembershipConfigmanagementConfigSyncDeploymentOverridesContainers {
	if o == nil {
...
func flattenGkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesContainersArray(objs []FeatureMembershipConfigmanagementConfigSyncDeploymentOverridesContainers) []interface{} {
	if objs == nil {
		return nil
	}
...
func flattenGkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesContainers(obj *FeatureMembershipConfigmanagementConfigSyncDeploymentOverridesContainers) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipConfigmanagementConfigSyncGit(o interface{}) *FeatureMembershipConfigmanagementConfigSyncGit {
	if o == nil {
...
func flattenGkeHubFeatureMembershipConfigmanagementConfigSyncGit(obj *FeatureMembershipConfigmanagementConfigSyncGit) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipConfigmanagementConfigSyncOci(o interface{}) *FeatureMembershipConfigmanagementConfigSyncOci {
	if o == nil {
...
func flattenGkeHubFeatureMembershipConfigmanagementConfigSyncOci(obj *FeatureMembershipConfigmanagementConfigSyncOci) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipConfigmanagementHierarchyController(o interface{}) *FeatureMembershipConfigmanagementHierarchyController {
	if o == nil {
...
func flattenGkeHubFeatureMembershipConfigmanagementHierarchyController(obj *FeatureMembershipConfigmanagementHierarchyController) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipConfigmanagementPolicyController(o interface{}) *FeatureMembershipConfigmanagementPolicyController {
	if o == nil {
	...
	return &FeatureMembershipConfigmanagementPolicyController{
		...
		Enabled:                  dcl.Bool(obj["enabled"].(bool)),
		ExemptableNamespaces:     dcl.ExpandStringArray(obj["exemptable_namespaces"]),
...
func flattenGkeHubFeatureMembershipConfigmanagementPolicyController(obj *FeatureMembershipConfigmanagementPolicyController) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipConfigmanagementPolicyControllerMonitoring(o interface{}) *FeatureMembershipConfigmanagementPolicyControllerMonitoring {
	if o == nil {
		return nil
	}
	objArr := o.([]interface{})
...
func flattenGkeHubFeatureMembershipConfigmanagementPolicyControllerMonitoring(obj *FeatureMembershipConfigmanagementPolicyControllerMonitoring) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipMesh(o interface{}) *FeatureMembershipMesh {
	if o == nil {
	...
	return &FeatureMembershipMesh{
		ControlPlane: FeatureMembershipMeshControlPlaneEnumRef(obj["control_plane"].(string)),
		Management:   FeatureMembershipMeshManagementEnumRef(obj["management"].(string)),
		ConfigApi:    FeatureMembershipMeshConfigApiEnumRef(obj["config_api"].(string)),
	}
}

func flattenGkeHubFeatureMembershipMesh(obj *FeatureMembershipMesh) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipPolicycontroller(o interface{}) *FeatureMembershipPolicycontroller {
	if o == nil {
...
func flattenGkeHubFeatureMembershipPolicycontroller(obj *FeatureMembershipPolicycontroller) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfig(o interface{}) *FeatureMembershipPolicycontrollerPolicyControllerHubConfig {
	if o == nil {
	...
	return &FeatureMembershipPolicycontrollerPolicyControllerHubConfig{
		...
		ExemptableNamespaces:     dcl.ExpandStringArray(obj["exemptable_namespaces"]),
		InstallSpec:              FeatureMembershipPolicycontrollerPolicyControllerHubConfigInstallSpecEnumRef(obj["install_spec"].(string)),
		LogDeniesEnabled:         dcl.Bool(obj["log_denies_enabled"].(bool)),
...
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfig(obj *FeatureMembershipPolicycontrollerPolicyControllerHubConfig) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsMap(o interface{}) map[string]FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigs {
	if o == nil {
		return nil
	}
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigs(o interface{}) *FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigs {
	if o == nil {
		return nil
	}
	...
	return &FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigs{
		...
		PodAffinity:        FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsPodAffinityEnumRef(obj["pod_affinity"].(string)),
...
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsMap(objs map[string]FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigs) []interface{} {
	if objs == nil {
		return nil
	}
...
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigs(obj *FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigs, name string) interface{} {
	if obj == nil {
		return nil
	}
	transformed := map[string]interface{}{
...
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsContainerResources(obj *FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsContainerResources) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsContainerResourcesLimits(obj *FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsContainerResourcesLimits) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsContainerResourcesRequests(o interface{}) *FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsContainerResourcesRequests {
	if o == nil {
...
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsContainerResourcesRequests(obj *FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsContainerResourcesRequests) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsPodTolerationsArray(o interface{}) []FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsPodTolerations {
	if o == nil {
		return make([]FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsPodTolerations, 0)
	}
	...
	items := make([]FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsPodTolerations, 0, len(objs))
	for _, item := range objs {
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsPodTolerations(o interface{}) *FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsPodTolerations {
	if o == nil {
...
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsPodTolerationsArray(objs []FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsPodTolerations) []interface{} {
	if objs == nil {
		return nil
	}
...
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsPodTolerations(obj *FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigsPodTolerations) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoring(o interface{}) *FeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoring {
	if o == nil {
		return nil
	}
	objArr := o.([]interface{})
...
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoring(obj *FeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoring) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContent(o interface{}) *FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContent {
	if o == nil {
		return nil
	}
	objArr := o.([]interface{})
...
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContent(obj *FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContent) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundlesMap(o interface{}) map[string]FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundles {
	if o == nil {
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundles(o interface{}) *FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundles {
	if o == nil {
	...
	return &FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundles{
		ExemptedNamespaces: dcl.ExpandStringArray(obj["exempted_namespaces"]),
	}
}

func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundlesMap(objs map[string]FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundles) []interface{} {
	if objs == nil {
		return nil
	}
...
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundles(obj *FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundles, name string) interface{} {
	if obj == nil {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibrary(o interface{}) *FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibrary {
	if o == nil {
		return nil
	}
	objArr := o.([]interface{})
	...
	return &FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibrary{
		Installation: FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibraryInstallationEnumRef(obj["installation"].(string)),
	}
}

func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibrary(obj *FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibrary) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func flattenGkeHubFeatureMembershipConfigmanagementPolicyControllerMonitoringBackendsArray(obj []FeatureMembershipConfigmanagementPolicyControllerMonitoringBackendsEnum) interface{} {
	if obj == nil {
		return nil
	}
	items := []string{}
...
func expandGkeHubFeatureMembershipConfigmanagementPolicyControllerMonitoringBackendsArray(o interface{}) []FeatureMembershipConfigmanagementPolicyControllerMonitoringBackendsEnum {
	objs := o.([]interface{})
	items := make([]FeatureMembershipConfigmanagementPolicyControllerMonitoringBackendsEnum, 0, len(objs))
	for _, item := range objs {
		i := FeatureMembershipConfigmanagementPolicyControllerMonitoringBackendsEnumRef(item.(string))
		items = append(items, *i)
	}
	return items
}
func flattenGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoringBackendsArray(obj []FeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoringBackendsEnum) interface{} {
	if obj == nil {
		return nil
	}
	items := []string{}
...
func expandGkeHubFeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoringBackendsArray(o interface{}) []FeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoringBackendsEnum {
	objs := o.([]interface{})
	items := make([]FeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoringBackendsEnum, 0, len(objs))
	for _, item := range objs {
		i := FeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoringBackendsEnumRef(item.(string))
		items = append(items, *i)
	}
	return items
}

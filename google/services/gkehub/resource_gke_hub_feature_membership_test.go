...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/gkehub/resource_gke_hub_feature_membership_test.go.tmpl
//
...
func TestAccGKEHubFeatureMembership_meshConfigApiUpdate(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccGKEHubFeatureMembership_meshConfigApiUpdateStart(context),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGkeHubFeatureMembershipPresent(t, fmt.Sprintf("tf-test-gkehub%s", context["random_suffix"]), "global", "servicemesh", fmt.Sprintf("tf-test1%s", context["random_suffix"])),
					resource.TestCheckResourceAttr("google_gke_hub_feature_membership.feature_member", "mesh.0.config_api", "CONFIG_API_ISTIO"),
				),
			},
			{
				ResourceName:      "google_gke_hub_feature_membership.feature_member",
			...
			{
				Config: testAccGKEHubFeatureMembership_meshConfigApiUpdate(context),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGkeHubFeatureMembershipPresent(t, fmt.Sprintf("tf-test-gkehub%s", context["random_suffix"]), "global", "servicemesh", fmt.Sprintf("tf-test1%s", context["random_suffix"])),
					resource.TestCheckResourceAttr("google_gke_hub_feature_membership.feature_member", "mesh.0.config_api", "CONFIG_API_GATEWAY"),
				),
			},
			{
				ResourceName:      "google_gke_hub_feature_membership.feature_member",
...
func testAccGKEHubFeatureMembership_meshConfigApiUpdateStart(context map[string]interface{}) string {
	return gkeHubFeatureProjectSetup(context) + acctest.Nprintf(`
resource "google_container_cluster" "primary" {
  project = google_project.project.project_id
  name               = "tf-test-cl%{random_suffix}"
...
resource "google_gke_hub_feature_membership" "feature_member" {
  ...
  membership = google_gke_hub_membership.membership.membership_id
  mesh {
    config_api = "CONFIG_API_ISTIO"
  }
}
`, context)
}

func testAccGKEHubFeatureMembership_meshConfigApiUpdate(context map[string]interface{}) string {
	return gkeHubFeatureProjectSetup(context) + acctest.Nprintf(`
resource "google_container_cluster" "primary" {
  project = google_project.project.project_id
  name               = "tf-test-cl%{random_suffix}"

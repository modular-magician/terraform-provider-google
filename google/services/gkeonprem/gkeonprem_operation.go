...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/gkeonprem/gkeonprem_operation.go
//
...
func (w *gkeonpremOperationWaiter) QueryOp() (interface{}, error) {
	...
	url := fmt.Sprintf("%s%s", w.Config.BasePaths["gkeonprem"], w.Op.Name)

...
//
//     Configuration: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/products/iap/AppEngineService.yaml
...
func init() {
	registry.Schema{
		...
		Schema:      tpgiamresource.ResourceIamBinding(IapAppEngineServiceIamSchema, IapAppEngineServiceIamUpdaterProducer, IapAppEngineServiceIdParseFunc),
	}.Register()
	registry.Schema{
		Name:        "google_iap_app_engine_service_iam_member",
		ProductName: "Iap",
		Type:        registry.SchemaTypeIAMResource,
		Schema:      tpgiamresource.ResourceIamMember(IapAppEngineServiceIamSchema, IapAppEngineServiceIamUpdaterProducer, IapAppEngineServiceIdParseFunc),
	}.Register()
	registry.Schema{
		Name:        "google_iap_app_engine_service_iam_policy",
		ProductName: "Iap",
		Type:        registry.SchemaTypeIAMResource,
		Schema:      tpgiamresource.ResourceIamPolicy(IapAppEngineServiceIamSchema, IapAppEngineServiceIamUpdaterProducer, IapAppEngineServiceIdParseFunc),
	}.Register()
	registry.Schema{
		Name:        "google_iap_app_engine_service_iam_policy",
		ProductName: "Iap",
		Type:        registry.SchemaTypeIAMDataSource,
		Schema:      tpgiamresource.DataSourceIamPolicy(IapAppEngineServiceIamSchema, IapAppEngineServiceIamUpdaterProducer),
	}.Register()
}
...
func IapAppEngineServiceIamUpdaterProducer(d tpgresource.TerraformResourceData, config *transport_tpg.Config) (tpgiamresource.ResourceIamUpdater, error) {
	...
	m, err := tpgresource.GetImportIdQualifiers([]string{"projects/(?P<project>[^/]+)/iap_web/appengine-(?P<appId>[^/]+)/services/(?P<service>[^/]+)", "(?P<project>[^/]+)/(?P<appId>[^/]+)/(?P<service>[^/]+)", "(?P<appId>[^/]+)/(?P<service>[^/]+)", "(?P<service>[^/]+)"}, d, config, d.Get("service").(string))
	if err != nil {
		return nil, err
	}
...
func IapAppEngineServiceIdParseFunc(d *schema.ResourceData, config *transport_tpg.Config) error {
	...
	m, err := tpgresource.GetImportIdQualifiers([]string{"projects/(?P<project>[^/]+)/iap_web/appengine-(?P<appId>[^/]+)/services/(?P<service>[^/]+)", "(?P<project>[^/]+)/(?P<appId>[^/]+)/(?P<service>[^/]+)", "(?P<appId>[^/]+)/(?P<service>[^/]+)", "(?P<service>[^/]+)"}, d, config, d.Id())
	if err != nil {
		return err
	}

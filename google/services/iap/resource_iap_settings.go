	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"name": {
				...
				Required:    true,
				Description: `The resource name of the IAP protected resource.`,
			},
			"access_settings": {
...
* 'WORKFORCE_IDENTITY_FEDERATION': Use external identities set up on Google Cloud Workforce
  				     Identity Federation. Possible values: ["IDENTITY_SOURCE_UNSPECIFIED", "WORKFORCE_IDENTITY_FEDERATION"]`,
							Elem: &schema.Schema{
								Type:         schema.TypeString,
								ValidateFunc: verify.ValidateEnum([]string{"IDENTITY_SOURCE_UNSPECIFIED", "WORKFORCE_IDENTITY_FEDERATION"}),
							},
						},
						"oauth_settings": {
							Type:        schema.TypeList,
...
Example: "3.5s".`,
									...
									"method": {
										Type:         schema.TypeString,
										Required:     true,
										ValidateFunc: verify.ValidateEnum([]string{"METHOD_UNSPECIFIED", "LOGIN", "SECURE_KEY", "ENROLLED_SECOND_FACTORS"}),
...
* 'ENROLLED_SECOND_FACTORS': User can use any enabled 2nd factor. Possible values: ["METHOD_UNSPECIFIED", "LOGIN", "SECURE_KEY", "ENROLLED_SECOND_FACTORS"]`,
									},
									"policy_type": {
										Type:         schema.TypeString,
										Required:     true,
										ValidateFunc: verify.ValidateEnum([]string{"POLICY_TYPE_UNSPECIFIED", "MINIMUM", "DEFAULT"}),
...
* 'DEFAULT': This policy acts as a default if no other reauth policy is set. Possible values: ["POLICY_TYPE_UNSPECIFIED", "MINIMUM", "DEFAULT"]`,
									},
								},
							},
						},
...
* 'RCTOKEN': Propagate attributes in the RCToken of the form: "
             additional_claims": { "my_attribute": ["value1", "value2"] } Possible values: ["OUTPUT_CREDENTIALS_UNSPECIFIED", "HEADER", "JWT", "RCTOKEN"]`,
										Elem: &schema.Schema{
											Type:         schema.TypeString,
											ValidateFunc: verify.ValidateEnum([]string{"OUTPUT_CREDENTIALS_UNSPECIFIED", "HEADER", "JWT", "RCTOKEN"}),
										},
									},
								},
							},
...
func flattenIapSettingsName(v interface{}, d *schema.ResourceData, config *transport_tpg.Config) interface{} {
	return v
}

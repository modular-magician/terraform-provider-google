...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionLoggingMetric,
		DeleteFunction: testSweepLoggingMetric,
	}
...
func testSweepLoggingMetric(_ string) error {
	return listAndActionLoggingMetric(deleteResourceLoggingMetric)
}

func listAndActionLoggingMetric(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceLoggingMetric(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {

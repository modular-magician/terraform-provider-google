...
func TestAccManagedKafkaAclBinding_managedkafkaAclBindingBasicExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckManagedKafkaAclBindingDestroyProducer(t),
		Steps: []resource.TestStep{
			{
				Config: testAccManagedKafkaAclBinding_managedkafkaAclBindingBasicExample(context),
			},
			{
				ResourceName:            "google_managed_kafka_acl_binding.example",
				ImportState:             true,
...
func testAccManagedKafkaAclBinding_managedkafkaAclBindingBasicExample(context map[string]interface{}) string {
...
func testAccCheckManagedKafkaAclBindingDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			...
			if err == nil {
				return fmt.Errorf("ManagedKafkaAclBinding still exists at %s", url)
			}
		}

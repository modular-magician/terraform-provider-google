...
func TestAccMemorystoreInstanceDesiredUserCreatedConnections_memorystoreInstanceDesiredUserCreatedConnectionsExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckMemorystoreInstanceDesiredUserCreatedConnectionsDestroyProducer(t),
		Steps: []resource.TestStep{
			{
				Config: testAccMemorystoreInstanceDesiredUserCreatedConnections_memorystoreInstanceDesiredUserCreatedConnectionsExample(context),
			},
			{
				ResourceName:            "google_memorystore_instance_desired_user_created_connections.instance-user-conn",
				ImportState:             true,
...
func testAccMemorystoreInstanceDesiredUserCreatedConnections_memorystoreInstanceDesiredUserCreatedConnectionsExample(context map[string]interface{}) string {
	return acctest.Nprintf(`

resource "google_memorystore_instance_desired_user_created_connections" "instance-user-conn" {
...
resource "google_memorystore_instance" "instance-basic-auto-push" {
...
func TestAccMemorystoreInstanceDesiredUserCreatedConnections_memorystoreInstanceDesiredUserAndAutoCreatedConnectionsExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccMemorystoreInstanceDesiredUserCreatedConnections_memorystoreInstanceDesiredUserAndAutoCreatedConnectionsExample(context),
			},
			{
				ResourceName:            "google_memorystore_instance_desired_user_created_connections.instance-user-auto-conn",
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"name", "region"},
			},
...
func testAccMemorystoreInstanceDesiredUserCreatedConnections_memorystoreInstanceDesiredUserAndAutoCreatedConnectionsExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_memorystore_instance_desired_user_created_connections" "instance-user-auto-conn" {
...
func testAccCheckMemorystoreInstanceDesiredUserCreatedConnectionsDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			if rs.Type != "google_memorystore_instance_desired_user_created_connections" {
				continue
			}
			...
			if err == nil {
				return fmt.Errorf("MemorystoreInstanceDesiredUserCreatedConnections still exists at %s", url)
			}
		}

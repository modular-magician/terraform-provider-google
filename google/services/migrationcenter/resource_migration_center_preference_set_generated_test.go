...
func TestAccMigrationCenterPreferenceSet_preferenceSetComputeEnginePreferencesExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccMigrationCenterPreferenceSet_preferenceSetComputeEnginePreferencesExample(context),
			},
			{
				ResourceName:            "google_migration_center_preference_set.default",
				ImportState:             true,
...
func testAccMigrationCenterPreferenceSet_preferenceSetComputeEnginePreferencesExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_migration_center_preference_set" "default" {
  location          = "us-central1"
  preference_set_id = "tf-test-preference-set-test%{random_suffix}"
  ...
  virtual_machine_preferences {
    ...
    compute_engine_preferences {
      ...
      persistent_disk_type = "COMPUTE_PERSISTENT_DISK_TYPE_STANDARD"
    }
  }
}
`, context)

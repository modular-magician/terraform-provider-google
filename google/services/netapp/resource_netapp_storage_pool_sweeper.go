...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetappStoragePool,
		DeleteFunction: testSweepNetappStoragePool,
	}
	// Add dependencies
...
func testSweepNetappStoragePool(_ string) error {
	return listAndActionNetappStoragePool(deleteResourceNetappStoragePool)
}

func listAndActionNetappStoragePool(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues := make([]map[string]string, 11)
	...
	intermediateValues[4]["location"] = "us-west4"
	intermediateValues[5] = map[string]string{}
	intermediateValues[5]["location"] = "northamerica-northeast1"
	intermediateValues[6] = map[string]string{}
	intermediateValues[6]["location"] = "us-central1-a"
	intermediateValues[7] = map[string]string{}
	intermediateValues[7]["location"] = "us-central1-c"
	intermediateValues[8] = map[string]string{}
	intermediateValues[8]["location"] = "us-east4-a"
	intermediateValues[9] = map[string]string{}
	intermediateValues[9]["location"] = "us-south1-a"
	intermediateValues[10] = map[string]string{}
	intermediateValues[10]["location"] = "europe-west3-a"
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'storagePools'")
		} else {
...
func deleteResourceNetappStoragePool(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {

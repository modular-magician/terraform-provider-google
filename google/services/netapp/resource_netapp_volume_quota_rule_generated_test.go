...
func testAccCheckNetappVolumeQuotaRuleDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			if rs.Type != "google_netapp_volume_quota_rule" {
				continue
			}
			...
			if err == nil {
				return fmt.Errorf("NetappVolumeQuotaRule still exists at %s", url)
			}
		}

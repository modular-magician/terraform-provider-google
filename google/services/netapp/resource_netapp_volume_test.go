...
func TestAccNetappUnifiedVolume_NetappVolumeBasicExample_update(t *testing.T) {
	context := map[string]interface{}{
		"network_name":  acctest.BootstrapSharedServiceNetworkingConnection(t, "gcnv-network-config-3", acctest.ServiceNetworkWithParentService("netapp.servicenetworking.goog")),
		"random_suffix": acctest.RandString(t, 10),
	}
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNetappUnifiedVolume_volumeBasicExample_basic(context),
			},
			{
				ResourceName:            "google_netapp_volume.test_volume",
				ImportState:             true,
			...
			{
				Config: testAccNetappUnifiedVolume_volumeBasicExample_update(context),
			},
			{
				ResourceName:            "google_netapp_volume.test_volume",
				ImportState:             true,
...
func testAccNetappUnifiedVolume_volumeBasicExample_basic(context map[string]interface{}) string {
	return acctest.Nprintf(`
    resource "google_netapp_storage_pool" "default" {
        name = "tf-test-test-pool%{random_suffix}"
        location = "us-central1-a"
...
func testAccNetappUnifiedVolume_volumeBasicExample_update(context map[string]interface{}) string {
	return acctest.Nprintf(`
    resource "google_netapp_storage_pool" "default" {
        name = "tf-test-test-pool%{random_suffix}"
        location = "us-central1-a"

...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkConnectivityServiceConnectionMap,
		DeleteFunction: testSweepNetworkConnectivityServiceConnectionMap,
	}
...
func testSweepNetworkConnectivityServiceConnectionMap(_ string) error {
	return listAndActionNetworkConnectivityServiceConnectionMap(deleteResourceNetworkConnectivityServiceConnectionMap)
}

func listAndActionNetworkConnectivityServiceConnectionMap(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkConnectivityServiceConnectionMap"
...
func deleteResourceNetworkConnectivityServiceConnectionMap(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {

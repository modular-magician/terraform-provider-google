...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkManagementNetworkMonitoringProvider,
		DeleteFunction: testSweepNetworkManagementNetworkMonitoringProvider,
	}
...
func testSweepNetworkManagementNetworkMonitoringProvider(_ string) error {
	return listAndActionNetworkManagementNetworkMonitoringProvider(deleteResourceNetworkManagementNetworkMonitoringProvider)
}

func listAndActionNetworkManagementNetworkMonitoringProvider(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkManagementNetworkMonitoringProvider"
...
func deleteResourceNetworkManagementNetworkMonitoringProvider(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {

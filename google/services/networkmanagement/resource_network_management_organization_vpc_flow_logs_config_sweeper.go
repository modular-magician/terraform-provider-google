...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_network_management_organization_vpc_flow_logs_config",
		ListAndAction:  listAndActionNetworkManagementOrganizationVpcFlowLogsConfig,
		DeleteFunction: testSweepNetworkManagementOrganizationVpcFlowLogsConfig,
	}
...
func testSweepNetworkManagementOrganizationVpcFlowLogsConfig(_ string) error {
	return listAndActionNetworkManagementOrganizationVpcFlowLogsConfig(deleteResourceNetworkManagementOrganizationVpcFlowLogsConfig)
}

func listAndActionNetworkManagementOrganizationVpcFlowLogsConfig(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkManagementOrganizationVpcFlowLogsConfig"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkmanagement.googleapis.com/v1/organizations/{{organization}}/locations/{{location}}/vpcFlowLogsConfigs", "?")[0]
...
func deleteResourceNetworkManagementOrganizationVpcFlowLogsConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkmanagement.googleapis.com/v1/organizations/{{organization}}/locations/{{location}}/vpcFlowLogsConfigs/{{vpc_flow_logs_config_id}}"

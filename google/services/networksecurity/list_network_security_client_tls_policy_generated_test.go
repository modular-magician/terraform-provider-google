...
func TestAccNetworkSecurityClientTlsPolicyListQuery_generated(t *testing.T) {
	t.Parallel()
	acctest.SkipIfVcr(t)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_network_security_client_tls_policy.default",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccNetworkSecurityClientTlsPolicy_networkSecurityClientTlsPolicyBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_security_client_tls_policy.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_security_client_tls_policy.list_query",
...
func testAccNetworkSecurityClientTlsPolicy_networkSecurityClientTlsPolicyBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_network_security_client_tls_policy" "list_query" {
    provider = google
	limit = 10000
    config {
    }

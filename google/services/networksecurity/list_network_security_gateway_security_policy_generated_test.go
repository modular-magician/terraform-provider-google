...
func TestAccNetworkSecurityGatewaySecurityPolicyListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccNetworkSecurityGatewaySecurityPolicy_networkSecurityGatewaySecurityPolicyBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_security_gateway_security_policy.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_security_gateway_security_policy.list_query",
...
func testAccNetworkSecurityGatewaySecurityPolicy_networkSecurityGatewaySecurityPolicyBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_network_security_gateway_security_policy" "list_query" {
    provider = google
	limit = 10000
    config {
    }

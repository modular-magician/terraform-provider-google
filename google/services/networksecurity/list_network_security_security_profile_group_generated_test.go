...
func TestAccNetworkSecuritySecurityProfileGroupListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccNetworkSecuritySecurityProfileGroup_networkSecuritySecurityProfileGroupBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_security_security_profile_group.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_security_security_profile_group.list_query",
...
func testAccNetworkSecuritySecurityProfileGroup_networkSecuritySecurityProfileGroupBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_network_security_security_profile_group" "list_query" {
    provider = google
	limit = 10000
    config {
    }

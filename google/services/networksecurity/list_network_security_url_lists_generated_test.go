...
func TestAccNetworkSecurityUrlListsListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccNetworkSecurityUrlLists_networkSecurityUrlListsBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_security_url_lists.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_security_url_lists.list_query",
...
func testAccNetworkSecurityUrlLists_networkSecurityUrlListsBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_network_security_url_lists" "list_query" {
    provider = google
	limit = 10000
    config {
    }

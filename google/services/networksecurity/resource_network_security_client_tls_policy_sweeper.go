...
func listAndActionNetworkSecurityClientTlsPolicy(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networksecurity.googleapis.com/v1/projects/{{project}}/locations/global/clientTlsPolicies", "?")[0]
...
func deleteResourceNetworkSecurityClientTlsPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networksecurity.googleapis.com/v1/projects/{{project}}/locations/global/clientTlsPolicies/{{name}}"

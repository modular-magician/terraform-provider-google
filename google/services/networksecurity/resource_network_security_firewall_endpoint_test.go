...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/networksecurity/resource_network_security_firewall_endpoint_test.go.tmpl
//
...
func TestAccNetworkSecurityFirewallEndpoints_wildfire(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNetworkSecurityFirewallEndpoints_wildfire(orgId, billingProjectId, randomSuffix),
			},
			{
				ResourceName:            "google_network_security_firewall_endpoint.foobar",
				ImportState:             true,
			...
			{
				Config: testAccNetworkSecurityFirewallEndpoints_wildfireUpdate(orgId, billingProjectId, randomSuffix),
			},
			{
				ResourceName:            "google_network_security_firewall_endpoint.foobar",
				ImportState:             true,
...
func testAccNetworkSecurityFirewallEndpoints_wildfire(orgId string, billingProjectId string, randomSuffix string) string {
	return fmt.Sprintf(`
resource "google_network_security_firewall_endpoint" "foobar" {
  name     = "tf-test-fw-endpoint%[1]s"
  parent   = "organizations/%[2]s"
  location = "us-central1-a"
  billing_project_id = "%[3]s"
...
func testAccNetworkSecurityFirewallEndpoints_wildfireUpdate(orgId string, billingProjectId string, randomSuffix string) string {
	return fmt.Sprintf(`
resource "google_network_security_firewall_endpoint" "foobar" {
  name     = "tf-test-fw-endpoint%[1]s"
  parent   = "organizations/%[2]s"
  ...
  wildfire_settings {
    enabled = false
    wildfire_region = "CANADA"

    wildfire_realtime_lookup_duration = "5s"
    wildfire_realtime_lookup_timeout_action = "DENY"

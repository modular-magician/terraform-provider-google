...
func listAndActionNetworkSecurityServerTlsPolicy(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networksecurity.googleapis.com/v1/projects/{{project}}/locations/global/serverTlsPolicies", "?")[0]
...
func deleteResourceNetworkSecurityServerTlsPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networksecurity.googleapis.com/v1/projects/{{project}}/locations/global/serverTlsPolicies/{{name}}"

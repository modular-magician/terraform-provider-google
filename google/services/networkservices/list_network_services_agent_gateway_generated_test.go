...
func TestAccNetworkServicesAgentGatewayListQuery_generated(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccNetworkServicesAgentGateway_networkServicesAgentGatewayFullExampleListQuery(context),
...
func testAccNetworkServicesAgentGateway_networkServicesAgentGatewayFullExampleListQuery(context map[string]interface{}) string {

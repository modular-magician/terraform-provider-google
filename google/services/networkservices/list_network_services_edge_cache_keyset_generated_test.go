...
func TestAccNetworkServicesEdgeCacheKeysetListQuery_generated(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_network_services_edge_cache_keyset.default",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccNetworkServicesEdgeCacheKeyset_networkServicesEdgeCacheKeysetBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_services_edge_cache_keyset.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_services_edge_cache_keyset.list_query",
...
func testAccNetworkServicesEdgeCacheKeyset_networkServicesEdgeCacheKeysetBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_network_services_edge_cache_keyset" "list_query" {
    provider = google
	limit = 10000
    config {
    }

...
func TestAccNetworkServicesEdgeCacheServiceListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_network_services_edge_cache_service.instance",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccNetworkServicesEdgeCacheService_networkServicesEdgeCacheServiceBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_services_edge_cache_service.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_services_edge_cache_service.list_query",
...
func testAccNetworkServicesEdgeCacheService_networkServicesEdgeCacheServiceBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_network_services_edge_cache_service" "list_query" {
    provider = google
	limit = 10000
    config {
    }

...
func TestAccNetworkServicesEndpointPolicyListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_network_services_endpoint_policy.default",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccNetworkServicesEndpointPolicy_networkServicesEndpointPolicyBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_services_endpoint_policy.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_services_endpoint_policy.list_query",
...
func testAccNetworkServicesEndpointPolicy_networkServicesEndpointPolicyBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_network_services_endpoint_policy" "list_query" {
    provider = google
	limit = 10000
    config {
    }

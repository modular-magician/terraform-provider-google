...
func init() {
	registry.FrameworkListResource{
		...
		Func:        NewNetworkServicesGatewayListResource,
	}.Register()
}

var _ list.ListResource = &NetworkServicesGatewayListResource{}

type NetworkServicesGatewayListResource struct {
	tpgresource.ListResourceMetadata
}

func NewNetworkServicesGatewayListResource() list.ListResource {
	listR := &NetworkServicesGatewayListResource{}
...
// NetworkServicesGatewayListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type NetworkServicesGatewayListModel struct {
	Location types.String `tfsdk:"location"`
	Project  types.String `tfsdk:"project"`
}

func (listR *NetworkServicesGatewayListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data NetworkServicesGatewayListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListNetworkServicesGateways(
			listR.Client,
			location,
			project,
...
func ListNetworkServicesGateways(config *transport_tpg.Config,
	location string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceNetworkServicesGateway().Data(&terraform.InstanceState{})
	if location != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{NetworkServicesBasePath}}projects/{{project}}/locations/{{location}}/gateways")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceNetworkServicesGateway(),
		ListURL:        url,

...
func init() {
	registry.FrameworkListResource{
		...
		Func:        NewNetworkServicesGrpcRouteListResource,
	}.Register()
}

var _ list.ListResource = &NetworkServicesGrpcRouteListResource{}

type NetworkServicesGrpcRouteListResource struct {
	tpgresource.ListResourceMetadata
}

func NewNetworkServicesGrpcRouteListResource() list.ListResource {
	listR := &NetworkServicesGrpcRouteListResource{}
...
// NetworkServicesGrpcRouteListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type NetworkServicesGrpcRouteListModel struct {
	Location types.String `tfsdk:"location"`
	Project  types.String `tfsdk:"project"`
}

func (listR *NetworkServicesGrpcRouteListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data NetworkServicesGrpcRouteListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListNetworkServicesGrpcRoutes(
			listR.Client,
			location,
			project,
...
func ListNetworkServicesGrpcRoutes(config *transport_tpg.Config,
	location string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceNetworkServicesGrpcRoute().Data(&terraform.InstanceState{})
	if location != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{NetworkServicesBasePath}}projects/{{project}}/locations/{{location}}/grpcRoutes")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceNetworkServicesGrpcRoute(),
		ListURL:        url,

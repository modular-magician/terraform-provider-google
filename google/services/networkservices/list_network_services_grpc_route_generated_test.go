...
func TestAccNetworkServicesGrpcRouteListQuery_generated(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_network_services_grpc_route.default",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccNetworkServicesGrpcRoute_networkServicesGrpcRouteBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_services_grpc_route.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_services_grpc_route.list_query",

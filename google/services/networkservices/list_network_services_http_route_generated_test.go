...
func TestAccNetworkServicesHttpRouteListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_network_services_http_route.default",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccNetworkServicesHttpRoute_networkServicesHttpRouteBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_services_http_route.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_services_http_route.list_query",
...
func testAccNetworkServicesHttpRoute_networkServicesHttpRouteBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_network_services_http_route" "list_query" {
    provider = google
	limit = 10000
    config {
    }

...
func init() {
	registry.FrameworkListResource{
		...
		Func:        NewNetworkServicesLbRouteExtensionListResource,
	}.Register()
}

var _ list.ListResource = &NetworkServicesLbRouteExtensionListResource{}

type NetworkServicesLbRouteExtensionListResource struct {
	tpgresource.ListResourceMetadata
}

func NewNetworkServicesLbRouteExtensionListResource() list.ListResource {
	listR := &NetworkServicesLbRouteExtensionListResource{}
	listR.TypeName = "google_network_services_lb_route_extension"
	listR.SDKv2Resource = ResourceNetworkServicesLbRouteExtension()
...
// NetworkServicesLbRouteExtensionListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type NetworkServicesLbRouteExtensionListModel struct {
	Location types.String `tfsdk:"location"`
	Project  types.String `tfsdk:"project"`
}

func (listR *NetworkServicesLbRouteExtensionListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data NetworkServicesLbRouteExtensionListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListNetworkServicesLbRouteExtensions(
			listR.Client,
			location,
			project,
...
func ListNetworkServicesLbRouteExtensions(config *transport_tpg.Config,
	location string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceNetworkServicesLbRouteExtension().Data(&terraform.InstanceState{})
	if location != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{NetworkServicesBasePath}}projects/{{project}}/locations/{{location}}/lbRouteExtensions")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceNetworkServicesLbRouteExtension(),
		ListURL:        url,
		BillingProject: billingProject,
		UserAgent:      userAgent,
		ItemName:       "lbRouteExtensions",
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err = ResourceNetworkServicesLbRouteExtensionFlatten(d, config, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}

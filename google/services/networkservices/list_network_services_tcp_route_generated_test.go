...
func TestAccNetworkServicesTcpRouteListQuery_generated(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_network_services_tcp_route.default",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccNetworkServicesTcpRoute_networkServicesTcpRouteBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_services_tcp_route.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_services_tcp_route.list_query",
...
func testAccNetworkServicesTcpRoute_networkServicesTcpRouteBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_network_services_tcp_route" "list_query" {
    provider = google
	limit = 10000
    config {
    }

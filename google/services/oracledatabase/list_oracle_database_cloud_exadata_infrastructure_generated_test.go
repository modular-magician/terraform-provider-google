...
func TestAccOracleDatabaseCloudExadataInfrastructureListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_oracle_database_cloud_exadata_infrastructure.my-cloud-exadata",
						[]string{
							"name",
			...
			{
				Query:           true,
				Config:          testAccOracleDatabaseCloudExadataInfrastructure_oracledatabaseCloudExadataInfrastructureBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_oracle_database_cloud_exadata_infrastructure.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_oracle_database_cloud_exadata_infrastructure.list_query",

...
func TestAccOracleDatabaseExascaleDbStorageVaultListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_oracle_database_exascale_db_storage_vault.my_storage_vault",
						[]string{
							"name",
			...
			{
				Query:           true,
				Config:          testAccOracleDatabaseExascaleDbStorageVault_oracledatabaseExascaleDbStorageVaultBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_oracle_database_exascale_db_storage_vault.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_oracle_database_exascale_db_storage_vault.list_query",

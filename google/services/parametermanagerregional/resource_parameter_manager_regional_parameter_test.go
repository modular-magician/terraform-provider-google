...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/parametermanagerregional/resource_parameter_manager_regional_parameter_test.go
//
...
func TestAccParameterManagerRegionalRegionalParameter_kmskeyUpdate(t *testing.T) {
	...
	context := map[string]interface{}{
		...
		"kms_key_other": kms.BootstrapKMSKeyWithPurposeInLocationAndName(t, "ENCRYPT_DECRYPT", "us-central1", "tf-parameter-manager-managed-central-key2").CryptoKey.Name,
		"random_suffix": acctest.RandString(t, 10),
	}
...
func TestAccParameterManagerRegionalRegionalParameter_tags(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccParameterManagerRegionalRegionalParameterTags(context),
			},
			{
...
func testAccParameterManagerRegionalRegionalParameterTags(context map[string]interface{}) string {
	return acctest.Nprintf(`

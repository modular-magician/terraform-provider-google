...
func TestAccPrivatecaCertificateTemplate_privatecaTemplateZeroMaxIssuerPathLengthExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccPrivatecaCertificateTemplate_privatecaTemplateZeroMaxIssuerPathLengthExample(context),
			},
			{
				ResourceName:            "google_privateca_certificate_template.default",
				ImportState:             true,
...
func testAccPrivatecaCertificateTemplate_privatecaTemplateZeroMaxIssuerPathLengthExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_privateca_certificate_template" "default" {
  name = "tf-test-my-template%{random_suffix}"
  location = "us-central1"

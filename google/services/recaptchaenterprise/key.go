...
type KeyAndroidSettings struct {
	...
	SupportNonGoogleAppStoreDistribution *bool    `json:"supportNonGoogleAppStoreDistribution"`
}
...
func (r *KeyAndroidSettings) UnmarshalJSON(data []byte) error {
	...
	if len(m) == 0 {
		*r = *EmptyKeyAndroidSettings
		...
		r.SupportNonGoogleAppStoreDistribution = res.SupportNonGoogleAppStoreDistribution
...
type KeyIosSettingsAppleDeveloperId struct {
	empty      bool    `json:"-"`
...
type jsonKeyIosSettingsAppleDeveloperId KeyIosSettingsAppleDeveloperId

func (r *KeyIosSettingsAppleDeveloperId) UnmarshalJSON(data []byte) error {
	var res jsonKeyIosSettingsAppleDeveloperId
	if err := json.Unmarshal(data, &res); err != nil {
		return err
	}
	...
	if len(m) == 0 {
		*r = *EmptyKeyIosSettingsAppleDeveloperId
	} else {
		r.KeyId = res.KeyId
...
var EmptyKeyIosSettingsAppleDeveloperId *KeyIosSettingsAppleDeveloperId = &KeyIosSettingsAppleDeveloperId{empty: true}

func (r *KeyIosSettingsAppleDeveloperId) Empty() bool {
	return r.empty
}

func (r *KeyIosSettingsAppleDeveloperId) String() string {
	var rCopy KeyIosSettingsAppleDeveloperId = *r
	if rCopy.PrivateKey != nil {
		rCopy.PrivateKey = dcl.String("[REDACTED]")
	}
	return dcl.SprintResource(&rCopy)
}

func (r *KeyIosSettingsAppleDeveloperId) HashCode() string {
	hash := sha256.Sum256([]byte(dcl.SprintResource(r)))
	return fmt.Sprintf("%x", hash)
}
...
type KeyIosSettings struct {
	...
	AppleDeveloperId  *KeyIosSettingsAppleDeveloperId `json:"appleDeveloperId"`
}
...
func (r *KeyIosSettings) UnmarshalJSON(data []byte) error {
	...
	if len(m) == 0 {
		*r = *EmptyKeyIosSettings
		...
		r.AppleDeveloperId = res.AppleDeveloperId

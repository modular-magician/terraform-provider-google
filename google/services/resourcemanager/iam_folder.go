...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/resourcemanager/iam_folder.go.tmpl
//
...
func init() {
	...
	registry.Schema{
		...
		ProductName: "resourcemanager",
		Type:        registry.SchemaTypeIAMResource,
		Schema:      tpgiamresource.ResourceIamMember(IamFolderSchema, NewFolderIamUpdater, FolderIdParseFunc, tpgiamresource.IamWithBatching, tpgiamresource.IamWithParentResourceIdentity(FolderIamParentParentResourceIdentityParser)),
	}.Register()
	registry.Schema{

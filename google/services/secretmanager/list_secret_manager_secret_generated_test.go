...
func TestAccSecretManagerSecretListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccSecretManagerSecret_secretConfigBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_secret_manager_secret.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_secret_manager_secret.list_query",

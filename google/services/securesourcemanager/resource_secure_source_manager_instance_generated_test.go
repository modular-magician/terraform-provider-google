...
func TestAccSecureSourceManagerInstance_secureSourceManagerInstanceCmekExample(t *testing.T) {
	...
	context := map[string]interface{}{
		"deletion_policy": "DELETE",
		"instance_id":     "tf-test-my-instance" + randomSuffix,
		"kms_key_name":    kms.BootstrapKMSKeyWithPurposeInLocationAndName(t, "ENCRYPT_DECRYPT", "us-central1", "tf-bootstrap-secure-source-manager-key1").CryptoKey.Name,
		"random_suffix":   randomSuffix,
	}
...
func TestAccSecureSourceManagerInstance_secureSourceManagerInstancePrivateCustomHostExample(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSecureSourceManagerInstance_secureSourceManagerInstancePrivateCustomHostExample(context),
			},
			{
				ResourceName:            "google_secure_source_manager_instance.default",
				ImportState:             true,
...
func testAccSecureSourceManagerInstance_secureSourceManagerInstancePrivateCustomHostExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
data "google_project" "project" {}
...
func testAccCheckSecureSourceManagerInstanceDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			...
			url, err := tpgresource.ReplaceVarsForTest(config, rs, transport_tpg.BaseUrl(securesourcemanager.Product, config)+"projects/{{project}}/locations/{{location}}/instances/{{instance_id}}")
			if err != nil {
				return err
			}

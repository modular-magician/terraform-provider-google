...
func resourceSecurityCenterManagementOrganizationEventThreatDetectionCustomModuleGetRawConfigAttributeAsString(d *schema.ResourceData, key string) string {

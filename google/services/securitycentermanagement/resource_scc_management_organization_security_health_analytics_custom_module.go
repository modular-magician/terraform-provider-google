...
func resourceSecurityCenterManagementOrganizationSecurityHealthAnalyticsCustomModuleGetRawConfigAttributeAsString(d *schema.ResourceData, key string) string {

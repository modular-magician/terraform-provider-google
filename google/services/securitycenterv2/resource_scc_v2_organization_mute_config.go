...
config creation or update.`,
			...
			"name": {
				Type:     schema.TypeString,
				Computed: true,
				Description: `Name of the Organization mute config. Its format is
...
func resourceSecurityCenterV2OrganizationMuteConfigCreate(d *schema.ResourceData, meta interface{}) error {
	...
	url, err := tpgresource.ReplaceVars(d, config, "{{SecurityCenterV2BasePath}}{{parent}}/locations/{location}/organizationmuteConfigs?organizationmuteConfigId={{organization_mute_Configs_id}}")
	if err != nil {
		return err
	}

...
func TestAccSecurityCenterV2OrganizationMuteConfig_sccOrganizationMuteConfigExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSecurityCenterV2OrganizationMuteConfig_sccOrganizationMuteConfigExample(context),
			},
			{
				ResourceName:            "google_scc_v2_organization_mute_config.default",
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"location", "organizationmute_config_id", "parent"},
			},
		},
	})
}

func testAccSecurityCenterV2OrganizationMuteConfig_sccOrganizationMuteConfigExample(context map[string]interface{}) string {

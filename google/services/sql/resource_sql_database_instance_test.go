...
func TestAccSqlDatabaseInstance_withPSCEnabled_withAutoConnectionPolicy(t *testing.T) {
	...
	networkName := tpgcompute.BootstrapSharedTestNetwork(t, "sql-psc-auto-conn")
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSqlDatabaseInstance_withPSCEnabled_withAutoConnectionPolicy(instanceName, projectId, networkName),
...
func testAccSqlDatabaseInstance_withPSCEnabled_withAutoConnectionPolicy(instanceName string, projectId string, networkName string) string {
	return fmt.Sprintf(`
    ...
    ip_configuration {
		psc_config {
			...
			psc_auto_connections {
				consumer_network            = data.google_compute_network.testnetwork.id
...
`, projectId, projectId, projectId, networkName, projectId, instanceName, projectId)
}

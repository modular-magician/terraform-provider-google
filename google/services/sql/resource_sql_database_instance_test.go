...
func TestAccSqlDatabaseInstance_createFromPointInTimeRestore(t *testing.T) {
	// Sqladmin client
	acctest.SkipIfVcr(t)
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSqlDatabaseInstance_pointInTimeRestore(context),
			},
			{
				ResourceName:            "google_sql_database_instance.instance",
				ImportState:             true,
...
func TestAccSqlDatabaseInstance_updateFromPointInTimeRestore(t *testing.T) {
	// Sqladmin client
	acctest.SkipIfVcr(t)
	t.Parallel()
...
func testAccSqlDatabaseInstance_pointInTimeRestore(context map[string]interface{}) string {
	return acctest.Nprintf(`
...
resource "google_backup_dr_backup_plan_association" "association" { 
  ...
  depends_on = [
    ...
    google_backup_dr_backup_plan.plan
  ]
}
...
resource "google_sql_database_instance" "instance" {
  ...
  point_in_time_restore_context {
    ...
    point_in_time = timeadd(google_backup_dr_backup_plan_association.association.create_time, "300s")
	target_instance = "%{project}:tf-test-%{random_suffix}-new"
  }

...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionSQLSourceRepresentationInstance,
		DeleteFunction: testSweepSQLSourceRepresentationInstance,
	}
...
func testSweepSQLSourceRepresentationInstance(_ string) error {
	return listAndActionSQLSourceRepresentationInstance(deleteResourceSQLSourceRepresentationInstance)
}

func listAndActionSQLSourceRepresentationInstance(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceSQLSourceRepresentationInstance(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	if isDeleting {
		log.Printf("[INFO][SWEEPER_LOG] %s resource %s is already deleting, skipping update of %s", resourceName, name, "settings.deletionProtectionEnabled")
	}

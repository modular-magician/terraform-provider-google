...
func TestAccStorageHmacKeyListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccStorageHmacKey_storageHmacKeyExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_storage_hmac_key.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_storage_hmac_key.list_query",

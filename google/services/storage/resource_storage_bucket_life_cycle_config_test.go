...
func TestAccStorageBucketLifeCycleConfig_Rules(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccStorageBucketLifeCycleConfig_lifecycleRules(bucketName),
			},
			{
			...
			{
				Config: testAccStorageBucketLifeCycleConfig_lifecycleRules_update(bucketName),
			},
			{
				ResourceName:            "google_storage_bucket_life_cycle_config.bucketlfcg",
				ImportState:             true,
...
func TestAccStorageBucketLifeCycleConfig_bucketLifecycleRuleUpdate(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccStorageBucketLifeCycleConfig_bucketLifecycleRules(bucketName),
			},
			{
				Config: testAccStorageBucketLifeCycleConfig_bucketLifecycleRulesUpdate(bucketName),
			},
			{
				ResourceName:            "google_storage_bucket_life_cycle_config.bucketlfcg",
				ImportState:             true,
...
func TestAccStorageBucketLifeCycleConfig_WithStateLive(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccStorageBucketLifeCycleConfig_lifecycleRuleWithStateLive(bucketName),
			},
			{
				ResourceName:            "google_storage_bucket_life_cycle_config.bucketlfcg",
				ImportState:             true,
...
func TestAccStorageBucketLifeCycleConfig_lifecycleRuleAnyState(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccStorageBucketLifeCycleConfig_lifecycleRuleWithStateArchived(bucketName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckStorageBucketExists(
						t, "google_storage_bucket.bucket", bucketName, &bucket),
					testAccCheckStorageBucketLifecycleRuleConditionState(googleapi.Bool(false), &bucket),
				),
			},
			{
				ResourceName:            "google_storage_bucket_life_cycle_config.bucketlfcg",
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckStorageBucketExists(
						t, "google_storage_bucket.bucket", bucketName, &bucket),
					testAccCheckStorageBucketLifecycleRuleConditionState(googleapi.Bool(true), &bucket),
				),
			},
			{
				ResourceName:            "google_storage_bucket_life_cycle_config.bucketlfcg",
			...
			{
				Config: testAccStorageBucketLifeCycleConfig_lifecycleRuleWithStateAny(bucketName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckStorageBucketExists(
						t, "google_storage_bucket.bucket", bucketName, &bucket),
					testAccCheckStorageBucketLifecycleRuleConditionState(nil, &bucket),
				),
			},
			{
				ResourceName:            "google_storage_bucket_life_cycle_config.bucketlfcg",
...
func TestAccStorageBucketLifeCycleConfig_lifecycleRulesVirtualFields(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccStorageBucketLifeCycleConfig_customAttributes(bucketName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckStorageBucketExists(
						t, "google_storage_bucket.bucket", bucketName, &bucket),
				),
			...
			{
				Config: testAccStorageBucketLifeCycleConfig_withLifecycleVirtualFieldsUpdate(bucketName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckStorageBucketExists(
						t, "google_storage_bucket.bucket", bucketName, &bucket),
...
func testAccStorageBucketLifeCycleConfig_customAttributes(bucketName string) string {
	return fmt.Sprintf(`
...
func testAccStorageBucketLifeCycleConfig_withLifecycleVirtualFieldsUpdate(bucketName string) string {
	return fmt.Sprintf(`
resource "google_storage_bucket" "bucket" {
  name          = "%s"
  location      = "EU"
...
func testAccStorageBucketLifeCycleConfig_lifecycleRuleWithStateArchived(bucketName string) string {
	return fmt.Sprintf(`
resource "google_storage_bucket" "bucket" {
  name          = "%s"
  location      = "US"
...
func testAccStorageBucketLifeCycleConfig_lifecycleRuleWithStateAny(bucketName string) string {
	return fmt.Sprintf(`
resource "google_storage_bucket" "bucket" {
  name          = "%s"
  location      = "US"
...
func testAccStorageBucketLifeCycleConfig_lifecycleRuleWithStateLive(bucketName string) string {
	return fmt.Sprintf(`
resource "google_storage_bucket" "bucket" {
  name          = "%s"
  location      = "US"
...
func testAccStorageBucketLifeCycleConfig_bucketLifecycleRules(bucketName string) string {
	return fmt.Sprintf(`
	resource "google_storage_bucket" "bucket" {
	  name          = "%s"
	  location      = "US"
...
func testAccStorageBucketLifeCycleConfig_bucketLifecycleRulesUpdate(bucketName string) string {
	return fmt.Sprintf(`
	resource "google_storage_bucket" "bucket" {
	  name          = "%s"
	  location      = "US"
...
func testAccStorageBucketLifeCycleConfig_lifecycleRules(bucketName string) string {
	return fmt.Sprintf(`
resource "google_storage_bucket" "bucket" {
  name          = "%s"
  location      = "US"
...
func testAccStorageBucketLifeCycleConfig_lifecycleRules_update(bucketName string) string {
	return fmt.Sprintf(`
resource "google_storage_bucket" "bucket" {
  name          = "%s"
  location      = "US"

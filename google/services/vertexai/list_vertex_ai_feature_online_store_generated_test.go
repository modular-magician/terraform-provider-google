...
func TestAccVertexAIFeatureOnlineStoreListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_vertex_ai_feature_online_store.feature_online_store",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccVertexAIFeatureOnlineStore_vertexAiFeatureOnlineStoreExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_vertex_ai_feature_online_store.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_vertex_ai_feature_online_store.list_query",
...
func testAccVertexAIFeatureOnlineStore_vertexAiFeatureOnlineStoreExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_vertex_ai_feature_online_store" "list_query" {
    provider = google
	limit = 10000
    config {
    }

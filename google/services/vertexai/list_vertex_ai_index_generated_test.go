...
func TestAccVertexAIIndexListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccVertexAIIndex_vertexAiIndexStreamingExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_vertex_ai_index.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_vertex_ai_index.list_query",
...
func testAccVertexAIIndex_vertexAiIndexStreamingExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_vertex_ai_index" "list_query" {
    provider = google
	limit = 10000
    config {
    }

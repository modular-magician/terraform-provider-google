...
func init() {
	registry.FrameworkListResource{
		...
		Func:        NewVertexAIScheduleListResource,
	}.Register()
}

var _ list.ListResource = &VertexAIScheduleListResource{}

type VertexAIScheduleListResource struct {
	tpgresource.ListResourceMetadata
}

func NewVertexAIScheduleListResource() list.ListResource {
	listR := &VertexAIScheduleListResource{}
	listR.TypeName = "google_vertex_ai_schedule"
	listR.SDKv2Resource = ResourceVertexAISchedule()
...
// VertexAIScheduleListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type VertexAIScheduleListModel struct {
	Location types.String `tfsdk:"location"`
	Project  types.String `tfsdk:"project"`
}

func (listR *VertexAIScheduleListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data VertexAIScheduleListModel
...
func ListVertexAISchedules(config *transport_tpg.Config,
	location string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceVertexAISchedule().Data(&terraform.InstanceState{})
	if location != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{VertexAIBasePath}}projects/{{project}}/locations/{{location}}/schedules")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceVertexAISchedule(),
		ListURL:        url,
		...
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err = ResourceVertexAIScheduleFlatten(d, config, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}

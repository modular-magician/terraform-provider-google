...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionVertexAIAgentAnomalyDetectionScope,
		DeleteFunction: testSweepVertexAIAgentAnomalyDetectionScope,
	}
...
func testSweepVertexAIAgentAnomalyDetectionScope(_ string) error {
	return listAndActionVertexAIAgentAnomalyDetectionScope(deleteResourceVertexAIAgentAnomalyDetectionScope)
}

func listAndActionVertexAIAgentAnomalyDetectionScope(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "VertexAIAgentAnomalyDetectionScope"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://{{region}}-aiplatform.googleapis.com/v1/projects/{{project}}/locations/{{region}}/agentAnomalyDetectionScopes", "?")[0]
...
func deleteResourceVertexAIAgentAnomalyDetectionScope(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://{{region}}-aiplatform.googleapis.com/v1/projects/{{project}}/locations/{{region}}/agentAnomalyDetectionScopes/{{agent_anomaly_detection_scope_id}}"

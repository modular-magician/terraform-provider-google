...
func flattenVmwareengineClusterAutoscalingSettingsAutoscalingPolicies(v interface{}, d *schema.ResourceData, config *transport_tpg.Config) interface{} {
	...
	for k, raw := range l {
		...
		transformed = append(transformed, map[string]interface{}{
			...
			"min_node_count":             flattenVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesMinNodeCount(original["minNodeCount"], d, config),
			"max_node_count":             flattenVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesMaxNodeCount(original["maxNodeCount"], d, config),
			...
			"granted_memory_thresholds":  flattenVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholds(original["grantedMemoryThresholds"], d, config),
...
func flattenVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesMinNodeCount(v interface{}, d *schema.ResourceData, config *transport_tpg.Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := tpgresource.StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesMaxNodeCount(v interface{}, d *schema.ResourceData, config *transport_tpg.Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := tpgresource.StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholds(v interface{}, d *schema.ResourceData, config *transport_tpg.Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
	...
	transformed := make(map[string]interface{})
	transformed["scale_out"] =
		flattenVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleOut(original["scaleOut"], d, config)
	transformed["scale_in"] =
		flattenVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleIn(original["scaleIn"], d, config)
	return []interface{}{transformed}
}
func flattenVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleOut(v interface{}, d *schema.ResourceData, config *transport_tpg.Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := tpgresource.StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesGrantedMemoryThresholdsScaleIn(v interface{}, d *schema.ResourceData, config *transport_tpg.Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := tpgresource.StringToFixed64(strVal); err == nil {
			return intVal

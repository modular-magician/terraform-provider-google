...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionVmwareengineNetworkPolicy,
		DeleteFunction: testSweepVmwareengineNetworkPolicy,
	}
	// Add dependencies
...
func testSweepVmwareengineNetworkPolicy(_ string) error {
	return listAndActionVmwareengineNetworkPolicy(deleteResourceVmwareengineNetworkPolicy)
}

func listAndActionVmwareengineNetworkPolicy(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceVmwareengineNetworkPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {

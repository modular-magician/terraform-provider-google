...
type IamSettings struct {
	...
	SchemaVersion      int
	CreateTimeOut      int64
	// ParentResourceIdentityParser, when non-nil, enables Terraform resource identity for this IAM
...
// IamWithParentResourceIdentity sets the parser that derives the canonical resource id from import identity when d.Id() is empty.

...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/transport/config_test.go
//
...
func TestResourceBasePathDefault(t *testing.T) {
	...
	for tn, tc := range cases {
		t.Run(tn, func(t *testing.T) {
			...
			basePath := transport_tpg.ResourceBasePath(tc.BasePath, tc.RepPath, tc.BasePathKey, tc.Config, tc.Location)

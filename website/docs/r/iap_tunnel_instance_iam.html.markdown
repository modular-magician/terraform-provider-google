...
```
$ terraform import google_iap_tunnel_instance_iam_binding.editor "projects/{{project}}/zones/{{zone}}/instances/{{tunnel_instance}} roles/iap.tunnelResourceAccessor"
```

IAM policy imports use the identifier of the resource in question, e.g.
```
$ terraform import google_iap_tunnel_instance_iam_policy.editor projects/{{project}}/zones/{{zone}}/instances/{{tunnel_instance}}
```
